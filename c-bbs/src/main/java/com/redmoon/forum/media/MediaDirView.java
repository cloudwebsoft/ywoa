...
public class MediaDirView {
    ...
    Logger logger = Logger.getLogger(MediaDirView.class.getName());
    MediaDirDb rootLeaf;
    Vector UprightLineNodes = new Vector(); //用于显示竖线

    public MediaDirView(MediaDirDb rootLeaf) {
    ...
    // 显示根结点为leaf的树
    void ListTree(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild) throws Exception {
        ShowLeaf(out, leaf, isLastChild);
        MediaDirMgr dm = new MediaDirMgr();
        ...
        while (ri.hasNext()) {
            i++;
            MediaDirDb childlf = (MediaDirDb) ri.next();
     ...
     **/
    void ShowLeaf(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild) throws Exception {
        ...
        if (!isLastChild) {
            MediaDirDb brotherleaf = leaf.getBrother("down");
...
*/
    ...
    void ShowDirAsOption(JspWriter out, MediaDirDb leaf, int rootlayer)
                  throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirAsOption(MediaDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirNameAsOptionValue(MediaDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    // 显示根结点为leaf的树
    public void ShowDirAsOptions(JspWriter out, MediaDirDb leaf, int rootlayer) throws Exception {
    ...
    public StringBuffer getDirAsOptions(StringBuffer outStr, MediaDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    public StringBuffer getDirNameAsOptions(StringBuffer outStr, MediaDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    // 显示根结点为leaf的树
    void ListTreeSimple(JspWriter out, MediaDirDb leaf,
        ...
        MediaDirMgr dir = new MediaDirMgr();
     ...
     * isLastChild 是否为其父亲结点的最后一个孩子结点
     **/
    void ShowLeafSimple(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFunc(JspWriter out, MediaDirDb leaf,
    ...
    void ShowLeafFunc(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFuncWithCheckbox(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
    ...
    void ShowLeafFuncWithCheckbox(JspWriter out, MediaDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
        ...
        // checkbox
        if (!code.equals(MediaDirDb.ROOTCODE))
