...
public class PassportConfig {
    ...
    private final String CONFIG_FILENAME = "config_passport.xml";
    private String cfgpath;
    Document doc = null;
    Element root = null;
    final String rootChild = "passport";
    public static PassportConfig config;
    private static Object initLock = new Object();

    public static PassportConfig getInstance() {
        if (config == null) {
            synchronized (initLock) {
                config = new PassportConfig();
                config.init();
            }
        }
        return config;
    ...
    public String getDescription(HttpServletRequest request, String name) {
        return SkinUtil.LoadString(request, "res.config.config_passport", name);
    }
