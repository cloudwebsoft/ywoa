...
public class GroupConfig {
    ...
    private final String CONFIG_FILENAME = "config_forum_group.xml";
    ...
    public static GroupConfig cfg = null;
    ...
    public void init() {
        logger = Logger.getLogger(GroupConfig.class.getName());
    ...
    public String getDescription(HttpServletRequest request, String name) {
        return SkinUtil.LoadString(request, "res.forum.plugin.group", name);
    }
}
