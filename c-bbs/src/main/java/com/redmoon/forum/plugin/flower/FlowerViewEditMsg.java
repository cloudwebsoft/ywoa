...
public class FlowerViewEditMsg implements IPluginViewEditMsg {
    HttpServletRequest request;
    public final String FORM_EDIT = "FORM_ADD";

    public FlowerViewEditMsg(HttpServletRequest request, String boardCode, long msgId) {
    ...
    public void init() {
        formElement = "";
        formNote = FlowerSkin.LoadString(request, "LABEL_EDIT_MSG");
        // 脚本
        // formNote += "<script src='plugin/" + FlowerSkin.code + "/script.js'></script>\n";
