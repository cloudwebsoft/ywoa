...
public class ReferViewAddMsg implements IPluginViewAddMsg {
    public final String FORM_ADD = "FORM_ADD";

    String boardCode;
    HttpServletRequest request;

    public ReferViewAddMsg(HttpServletRequest request, String boardCode) {
    ...
    public void init() {
        formElement = ReferSkin.LoadString(request, FORM_ADD);
    }
    ...
    public String render(int position) {
        ...
        case UIAddMsg.POS_TITLE:
            str += ReferSkin.LoadString(request, "addMsgTitle");
            break;
