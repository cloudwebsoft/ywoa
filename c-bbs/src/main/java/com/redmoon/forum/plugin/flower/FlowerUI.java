...
public class FlowerUI implements IPluginUI {
    HttpServletRequest request;

    public FlowerUI(HttpServletRequest request) {
    ...
    public IPluginViewListThread getViewListThread(String boardCode) {
        return new FlowerViewListThread(request, boardCode);
    }

    public IPluginViewAddMsg getViewAddMsg(String boardCode) {
        return new FlowerViewAddMsg(request, boardCode);
    }

    public IPluginViewAddReply getViewAddReply(String boardCode, long msgRootId) {
        return new FlowerViewAddReply(request, boardCode, msgRootId);
    }

    public IPluginViewEditMsg getViewEditMsg(String boardCode, long msgId) {
        return new FlowerViewEditMsg(request, boardCode, msgId);
    }
    ...
    public IPluginViewShowMsg getViewShowMsg(String boardCode, MsgDb msgDb) {
        return new FlowerViewShowMsg(request, boardCode, msgDb);
    }

    public ISkin getSkin() {
        return new FlowerSkin();
    }
}
