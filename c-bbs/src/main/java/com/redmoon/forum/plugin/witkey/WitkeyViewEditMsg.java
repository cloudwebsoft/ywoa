...
public class WitkeyViewEditMsg implements IPluginViewEditMsg {
    HttpServletRequest request;
    public final String FORM_EDIT = "FORM_ADD";

    public WitkeyViewEditMsg(HttpServletRequest request, String boardCode, long msgId) {
    ...
    public void init() {
        formElement = "";
        formNote = WitkeySkin.LoadString(request, "LABEL_EDIT_MSG");
        // 脚本
