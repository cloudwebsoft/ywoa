...
public class FlowerPrivilege implements IPluginPrivilege {
    static Logger logger = Logger.getLogger(FlowerPrivilege.class.getName());

    public FlowerPrivilege() {
    }
    ...
    public boolean canAddNew(HttpServletRequest request, String boardCode, FileUpload fu) throws ErrMsgException {
        ...
        if (!sb.isPluginBoard(FlowerUnit.code, boardCode))
