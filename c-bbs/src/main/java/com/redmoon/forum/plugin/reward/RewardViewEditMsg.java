...
public class RewardViewEditMsg implements IPluginViewEditMsg {
    HttpServletRequest request;
    public final String FORM_EDIT = "FORM_ADD";

    public RewardViewEditMsg(HttpServletRequest request, String boardCode, long msgId) {
    ...
    public void init() {
        formElement = "";
        formNote = RewardSkin.LoadString(request, "LABEL_EDIT_MSG");
        // 脚本
        // formNote += "<script src='plugin/" + RewardSkin.code + "/script.js'></script>\n";
