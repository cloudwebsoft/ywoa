...
public class GroupViewAddMsg implements IPluginViewAddMsg {
    public final String FORM_ADD = "FORM_ADD";

    String boardCode;
    HttpServletRequest request;

    public GroupViewAddMsg(HttpServletRequest request, String boardCode) {
    ...
    public void init() {
        formElement = GroupSkin.LoadString(request, FORM_ADD);
    }
    ...
    public String render(int position) {
        ...
        case UIAddMsg.POS_TITLE:
            str += GroupSkin.LoadString(request, "addMsgTitle");
            break;
