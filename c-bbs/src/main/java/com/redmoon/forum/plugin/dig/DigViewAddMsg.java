...
public class DigViewAddMsg implements IPluginViewAddMsg {
    public final String FORM_ADD = "FORM_ADD";

    String boardCode;
    HttpServletRequest request;

    public DigViewAddMsg(HttpServletRequest request, String boardCode) {
    ...
    public void init() {
        formElement = DigSkin.LoadString(request, FORM_ADD);
    }
    ...
    public String render(int position) {
        ...
        case UIAddMsg.POS_TITLE:
            str += DigSkin.LoadString(request, "addMsgTitle");
            break;
