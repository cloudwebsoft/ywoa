...
public class DebateUnit implements IPluginUnit {
    public static final String code = "debate";

    public DebateUnit() {
    }

    public IPluginUI getUI(HttpServletRequest request, HttpServletResponse response, JspWriter out) {
        return new DebateUI(request, response, out);
    }

    public IPluginPrivilege getPrivilege() {
        return new DebatePrivilege();
    }
