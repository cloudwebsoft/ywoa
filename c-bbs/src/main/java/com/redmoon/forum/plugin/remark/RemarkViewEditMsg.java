...
public class RemarkViewEditMsg implements IPluginViewEditMsg {
    HttpServletRequest request;
    public final String FORM_EDIT = "FORM_ADD";

    public RemarkViewEditMsg(HttpServletRequest request, String boardCode, long msgId) {
    ...
    public void init() {
        formElement = "";
        formNote = RemarkSkin.LoadString(request, "LABEL_EDIT_MSG");
        // 脚本
