...
public class MusicDirView {
    ...
    Logger logger = Logger.getLogger(MusicDirView.class.getName());
    MusicDirDb rootLeaf;
    Vector UprightLineNodes = new Vector(); //用于显示竖线

    public MusicDirView(MusicDirDb rootLeaf) {
    ...
    // 显示根结点为leaf的树
    void ListTree(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild) throws Exception {
        ShowLeaf(out, leaf, isLastChild);
        MusicDirMgr dm = new MusicDirMgr();
     ...
     **/
    void ShowLeaf(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild) throws Exception {
        ...
        if (!isLastChild) {
            MusicDirDb brotherleaf = leaf.getBrother("down");
...
*/
    ...
    void ShowDirAsOption(JspWriter out, MusicDirDb leaf, int rootlayer)
                  throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirAsOption(MusicDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirNameAsOptionValue(MusicDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    // 显示根结点为leaf的树
    public void ShowDirAsOptions(JspWriter out, MusicDirDb leaf, int rootlayer) throws Exception {
    ...
    public StringBuffer getDirAsOptions(StringBuffer outStr, MusicDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    public StringBuffer getDirNameAsOptions(StringBuffer outStr, MusicDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    // 显示根结点为leaf的树
    void ListTreeSimple(JspWriter out, MusicDirDb leaf,
     ...
     * isLastChild 是否为其父亲结点的最后一个孩子结点
     **/
    void ShowLeafSimple(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFunc(JspWriter out, MusicDirDb leaf,
    ...
    void ShowLeafFunc(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFuncWithCheckbox(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
    ...
    void ShowLeafFuncWithCheckbox(JspWriter out, MusicDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
        ...
        // checkbox
        if (!code.equals(MusicDirDb.ROOTCODE))
