 ...
 * @version 1.0
 */
public class MessageReportDb extends QObjectDb{
    public MessageReportDb() {
    }

    public MessageReportDb getMessageReportDb(long id) {
        return (MessageReportDb) getQObjectDb(new Long(id));
    }
