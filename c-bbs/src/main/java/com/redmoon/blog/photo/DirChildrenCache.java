...
public class DirChildrenCache {
    ...
    static String cachePrix = "blog_photo_dir_list_";
    Vector list = null;
    static String group = "Blog_Photo_Leaf_Children";
    ...
    public static void remove(String parentCode) {
        try {
            ...
            LogUtil.getLog("com.redmoon.blog.photo.DirChildrenCache").error(e.getMessage());
        }
    }
