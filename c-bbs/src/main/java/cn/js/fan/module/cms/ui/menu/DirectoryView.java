...
*/
    ...
    void ShowLeaf(JspWriter out, Leaf leaf,
        ...
        if (!icon.equals("")) {
            icon = "<img src='" + request.getContextPath() + "/images/icons/" + icon + "' align='absmiddle'>";
        }
        else {
        ...
        if (leaf.getCode().equals(rootLeaf.getCode())) { // 如果是根结点
            out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='images/i_puls-root.gif' align='absmiddle'>" + icon);
        } else {
            if (isLastChild) { // 是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img tableRelate='" + tableid + "' onClick=\"ShowChild(this, '" + tableid + "')\" src='images/i_plus2-2.gif' align='absmiddle'>" + icon);
                else
                    out.println("<img src='images/i_plus-2-3.gif' align='absmiddle'>" + icon);
            } else { // 不是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img tableRelate='" + tableid + "' onClick=\"ShowChild(this, '" + tableid + "')\" src='images/i_plus2-1.gif' align='absmiddle'>" + icon);
                else
                    out.println("<img src='images/i_plus-2-2.gif' align='absmiddle'>" + icon);
            }
        }
