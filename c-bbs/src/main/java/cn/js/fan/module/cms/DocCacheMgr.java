...
public class DocCacheMgr implements ICacheMgr {
    ...
    public final static String FULLTEXT = "CMS_FULLTEXT"; // 用于全文检索，使用like %...%
    public final static String ALL = "CMS_ALL";
    String COUNT_GROUP_NAME = "DOC_SQL_COUNT_";
    String DOCBLOCKCACHEPRIX = "DOC_BLOCK_";
    String cachePrix = "cms_doc_";
    ...
    /**
     * 当列出父目录的子目录中的文章时，得出当使用doc.getDocuments方法时，groupKey参数
     * @param parentCode String
     * @return String
     */
    public static String getVisualDirWhileGetDocumentsFromParentDir(String parentCode) {
        return CHILDREN_OF_PARENT + parentCode;
    }
    ...
    public void refreshUpdate(int id, String dir_code, String parent_code) {
        ...
        try {
            ...
            // System.out.println(getClass() + " refreshUpdate:" + ALL);
    ...
    public void refreshChangeDirCode(String dirCodeFrom, String dirCodeTo) {
        try {
            ...
            logger.error("refreshChangeDirCode:" + e.getMessage());
        }
    }
        ...
        // Otherwise, we have to load up the block from the database.
            ...
            try {
                ...
                while (rs.next() && count < DOC_BLOCK_SIZE) {
                    // System.out.print(getClass() + " id=" + rs.getLong(1));
