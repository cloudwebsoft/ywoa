...
public class SoftwareDirView {
    public SoftwareDirView() {
        try {
            jbInit();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    Logger logger = Logger.getLogger(SoftwareDirView.class.getName());
    SoftwareDirDb rootLeaf;
    Vector UprightLineNodes = new Vector(); //用于显示竖线

    public SoftwareDirView(SoftwareDirDb rootLeaf) {
    ...
    // 显示根结点为leaf的树
    void ListTree(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild) throws Exception {
        ShowLeaf(out, leaf, isLastChild);
        SoftwareDirMgr dm = new SoftwareDirMgr();
     ...
     **/
    void ShowLeaf(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild) throws Exception {
        ...
        if (!isLastChild) {
            SoftwareDirDb brotherleaf = leaf.getBrother("down");
...
*/
    ...
    void ShowDirAsOption(JspWriter out, SoftwareDirDb leaf, int rootlayer)
                  throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirAsOption(SoftwareDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirNameAsOptionValue(SoftwareDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    // 显示根结点为leaf的树
    public void ShowDirAsOptions(JspWriter out, SoftwareDirDb leaf, int rootlayer) throws Exception {
    ...
    public StringBuffer getDirAsOptions(StringBuffer outStr, SoftwareDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    public StringBuffer getDirNameAsOptions(StringBuffer outStr, SoftwareDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    // 显示根结点为leaf的树
    void ListTreeSimple(JspWriter out, SoftwareDirDb leaf,
     ...
     * isLastChild 是否为其父亲结点的最后一个孩子结点
     **/
    void ShowLeafSimple(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFunc(JspWriter out, SoftwareDirDb leaf,
    ...
    void ShowLeafFunc(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFuncWithCheckbox(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
    ...
    void ShowLeafFuncWithCheckbox(JspWriter out, SoftwareDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
        ...
        // checkbox
        if (!code.equals(SoftwareDirDb.ROOTCODE))
