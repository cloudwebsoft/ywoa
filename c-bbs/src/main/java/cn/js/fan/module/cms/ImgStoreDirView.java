...
public class ImgStoreDirView {
    public ImgStoreDirView() {
        try {
            jbInit();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    Logger logger = Logger.getLogger(ImgStoreDirView.class.getName());
    ImgStoreDirDb rootLeaf;
    Vector UprightLineNodes = new Vector(); //用于显示竖线

    public ImgStoreDirView(ImgStoreDirDb rootLeaf) {
    ...
    // 显示根结点为leaf的树
    void ListTree(JspWriter out, ImgStoreDirDb leaf,
        ...
        while (ri.hasNext()) {
            i++;
            ImgStoreDirDb childlf = (ImgStoreDirDb) ri.next();
     ...
     **/
    void ShowLeaf(JspWriter out, ImgStoreDirDb leaf,
                  boolean isLastChild) throws Exception {
        ...
        if (!isLastChild) {
            ImgStoreDirDb brotherleaf = leaf.getBrother("down");
...
*/
    ...
    void ShowDirAsOption(JspWriter out, ImgStoreDirDb leaf, int rootlayer)
                  throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirAsOption(ImgStoreDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirNameAsOptionValue(ImgStoreDirDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    // 显示根结点为leaf的树
    public void ShowDirAsOptions(JspWriter out, ImgStoreDirDb leaf, int rootlayer) throws Exception {
    ...
    public StringBuffer getDirAsOptions(StringBuffer outStr, ImgStoreDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    public StringBuffer getDirNameAsOptions(StringBuffer outStr, ImgStoreDirDb leaf, int rootlayer) throws ErrMsgException {
    ...
    // 显示根结点为leaf的树
    void ListTreeSimple(JspWriter out, ImgStoreDirDb leaf,
     ...
     * isLastChild 是否为其父亲结点的最后一个孩子结点
     **/
    void ShowLeafSimple(JspWriter out, ImgStoreDirDb leaf,
                  boolean isLastChild, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFunc(JspWriter out, ImgStoreDirDb leaf,
    ...
    void ShowLeafFunc(JspWriter out, ImgStoreDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFuncWithCheckbox(JspWriter out, ImgStoreDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
    ...
    void ShowLeafFuncWithCheckbox(JspWriter out, ImgStoreDirDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
        ...
        // checkbox
        if (!code.equals(ImgStoreDirDb.ROOTCODE))
