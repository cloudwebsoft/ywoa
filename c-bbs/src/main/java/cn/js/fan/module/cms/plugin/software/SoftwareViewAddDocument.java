...
public class SoftwareViewAddDocument implements IPluginViewAddDocument {
    public final String FORM_ADD = "FORM_ADD";

    String dirCode;
    HttpServletRequest request;

    public SoftwareViewAddDocument(HttpServletRequest request, String dirCode) {
    ...
    public void init() {
        formElement = SoftwareSkin.LoadString(request, FORM_ADD);
    }
