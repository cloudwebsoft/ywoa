    ...
    public static String getMenuItem(HttpServletRequest request, Leaf lf) {
        if (lf.getPreCode().equals(FORUM_BOARD)) {
            ...
            while (ir.hasNext()) {
                ...
                str += "<li><img align=\"absmiddle\" src=\"" + request.getContextPath() + "/images/arrow.gif\" />&nbsp;&nbsp;<a target=\"mainFrame\" href=\"" + request.getContextPath() + "/forum/admin/dir_frame.jsp?root_code=" + StrUtil.UrlEncode(leaf.getCode()) + "\">" + leaf.getName() + "</a></li>";
            }
            return str;
        }
            ...
            while (ir.hasNext()) {
                ...
                str += "<li><img align=\"absmiddle\" src=\"" + request.getContextPath() + "/images/arrow.gif\" />&nbsp;&nbsp;<a target=\"mainFrame\" href=\"" + request.getContextPath() + "/blog/admin/dir_frame.jsp?root_code=" + StrUtil.UrlEncode(leaf.getCode()) + "\">" + leaf.getName() + "</a></li>";
            }
            return str;
        }
        	...
        	while (ir.hasNext()) {
        		...
        		if (pu!=null && !pu.getAdminEntrance().trim().equals("")) {
        			str += "<li><IMG src=\"" + request.getContextPath() + "/images/arrow.gif\" width=5 align=absMiddle>&nbsp;&nbsp;";
