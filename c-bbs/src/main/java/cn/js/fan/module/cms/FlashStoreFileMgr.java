...
public class FlashStoreFileMgr {
    ...
    public boolean del(HttpServletRequest request, long id) throws
            ErrMsgException {
        FlashStoreFileDb doc = new FlashStoreFileDb();
        doc = getFlashStoreFileDb(id);
