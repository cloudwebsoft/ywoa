...
function(b){f.targetEl=b.currentTarget;b=a(f.targetEl);a("#bigBgshowDiv").css("backgroundColor","#000000");a("#bigHexColorText").val("#000000");b=p(b);a("#bigpicker").css({left:b.left+"px",top:b.top+"px", zIndex:9999999, position:"absolute", backgroundColor: "#f0f0f0", padding: "2px 0 1px 5px", borderLeft: "solid 1px #cccccc",borderTop: "solid 1px #cccccc",borderRight: "solid 1px #565656",borderBottom: "solid 1px #565656"}).fadeIn(300);b=a("#bigSections").position();a("#bigLayout").css({left:b.left,top:b.top}).show()});a(document).bind("mousedown",function(b){a(b.target).parents().andSelf().is("#bigpicker")||a("#bigpicker").hide()});if(d!=void 0)try{d=d.toUpperCase()}catch(g){d="P"}if(d=="L")a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").removeClass("bigpicker-bgimage"),
u();else{(new Image).src="../src/assets/images/big_bgcolor.jpg";a("#bigSections").height(134).width(222).addClass("bigpicker-bgimage").empty();a("#bigpicker").width(227).height(163);var i=r(e*3+2),m=r(e*3);a("#bigSections").unbind("mousemove").unbind("mouseout").unbind("click").mousemove(function(b){for(var d=a(this),h=b.pageX-d.offset().left,b=b.pageY-d.offset().top,f=0,g=0,l=0;l<e*3+2;l++)if(h>=i[l][0]&&h<=i[l][1]){f=l;break}for(l=0;l<e*3;l++)if(b>=m[l][0]&&b<=m[l][1]){g=l;break}a("#bigLayout").css({left:d.position().left+
