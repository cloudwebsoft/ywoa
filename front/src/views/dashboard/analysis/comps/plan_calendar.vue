  ...
  <div>
    <ShareCard :loading="isLoading" :cardData="cardData">
      ...
      <div class="bg-white h-full my-schedule">
        <div class="w-full flex justify-center h-9 items-center">
          <div>
            <DatePicker
              v-model:value="date"
              :picker="activeType"
        ...
        <Table :data-source="myDataSource" :pagination="false" bordered>
            ...
            >
              ...
              <template #default="{ text }">
                <template v-if="activeType === 'month'">
                  <div v-if="item.title === '周'">{{ text }}</div>
                  <div
                    v-else
                    class="h-full flex flex-col justify-center items-center"
                    :class="{ 'bg-blue-400 text-white': text.con && text.con.length > 0 }"
                  >
                    <div class="h-full">
                      <div class="">
                        <template v-if="text.con.length == 0">
                          <div
                            class="hover:text-red-400 hover:underline cursor-pointer"
...
<script lang="ts">
  ...
  import { Card, DatePicker, Radio, Table, Dropdown, Menu, Popconfirm } from 'ant-design-vue';
...
<style scoped>
  ...
  ::v-deep .ant-table tfoot > tr > th,
  ::v-deep .ant-table tfoot > tr > td {
    padding: 2px;
  }
</style>
