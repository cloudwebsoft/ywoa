...
<script lang="ts">
  ...
  import { Transfer, Checkbox, Button } from 'ant-design-vue';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { getFrontColProps, getBackColProps, updateFrontColProps } from '/@/api/module/module';
  ...
  export default defineComponent({
    name: 'SetModuleColumnModal',
    components: { BasicModal, Transfer, Checkbox, Icon, Button },
    ...
    setup(_, { emit }) {
      ...
      async function handleSubmit() {
        try {
          ...
          await updateFrontColProps(params);
      ...
      async function getColumnProps() {
        ...
        await getFrontColProps(params).then((res) => {
          let data = res || [];
          data.forEach((item) => {
      ...
      async function getFieldsList() {
        ...
        await getBackColProps(params).then((res) => {
          let data = res || [];
          data.forEach((item) => {
            item.key = item.name ? item.name : item.field;
