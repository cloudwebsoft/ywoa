...
public class QueryScriptUtil {
	...
	public String getSqlOrderByReplaced(String sql, String orderBy, String sort) {
		...
		QueryOrderByDeParser deParser = new QueryOrderByDeParser(expressionDeParser, stringBuffer);
	...
	public String getSqlSearchInResult(HttpServletRequest request, FormQueryDb fqd, String sql) {
		...
		QuerySearchInResultDeParser deParser = new QuerySearchInResultDeParser(request, fqd, expressionDeParser, stringBuffer);
