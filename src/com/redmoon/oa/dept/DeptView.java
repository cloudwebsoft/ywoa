...
public class DeptView {
    ...
    void ShowLeaf(JspWriter out, DeptDb leaf,
        ...
        if (leaf.getType() == 2) {
            ...
            out.print(
                    "<a target=_parent href='dept_user.jsp?deptCode=" +
...
*/
    ...
    public StringBuffer getUnitAsOptions(StringBuffer outStr, DeptDb leaf, int rootlayer) throws ErrMsgException {
    	// 不是企业版，则返回空
        if (!License.getInstance().getVersionType().equals(License.VERSION_GROUP) && !License.getInstance().isPlatform())
    ...
    public void ListSimple(HttpServletRequest request, JspWriter out, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        ...
        String strDepts = usd.getMessageToDept();
    ...
    void ShowLeafSimple(String[] depts, JspWriter out, DeptDb leaf,
        ...
        if (cfg.get("restrictUserDept").equals("true")) {
            if (depts!=null) {
 ...
 // 显示根结点为leaf的树
    ...
    public void ListFunc(HttpServletRequest request, JspWriter out,
        ...
        String strDepts = usd.getMessageToDept();
        String[] depts = StrUtil.split(strDepts, ",");
        ListTreeFunc(depts, out, rootLeaf, true, target, func, tableClass,
                     tableClassMouseOn);
    }
    ...
    void ShowLeafSimpleAjax(HttpServletRequest request, String[] depts, Privilege privilege, JspWriter out, DeptDb leaf,
        ...
        if (isRestricted) {
        	...
        	if (link.indexOf("?")!=-1)
        		t = "&";
            out.print(
                    "<a " + className+ " target='" + target + "' href='" + link + t + "deptCode=" +
                    StrUtil.UrlEncode(code) + "'>" + name + "</a>");
        }
        out.print("     </td>");
        out.println("  </tr></tbody></table>");
	...
	public String getJsonString(boolean isOpenAll) throws Exception {
		return getJsonString(isOpenAll, false);
	}
	
	public String getJsonString(boolean isOpenAll, boolean isShowNodeHided) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ArrayList<String> getAllHided() throws Exception {
		ArrayList<String> list = new ArrayList<String>();
