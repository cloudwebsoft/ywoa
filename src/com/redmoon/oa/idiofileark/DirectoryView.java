    ...
    void ShowLeafSimple(JspWriter out, Leaf leaf,
        ...
        for (int k = rootLeaf.getLayer(); k <= layer - 1; k++) {
            ...
            while (ir.hasNext()) {
                ...
                //如果在K层上存在一个竖线结点则画出
                if (node.getLayer() == k) {
                    node.show(out, "../netdisk/images/i_plus-2.gif");
                    if (node.getCount() == 0) {
        ...
        String folderImgStr = "<img id='img" + code + "' name='img" + code + "' src='../netdisk/images/" + folderImg + "' align='absmiddle'>";

        if (leaf.getCode().equals(rootLeaf.getCode())) { // 如果是根结点
            out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_puls-root.gif' align='absmiddle'>" + folderImgStr);
        } else {
            if (isLastChild) { // 是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_plus2-2.gif' align='absmiddle'>" + folderImgStr);
                else
                    out.println("<img src='../netdisk/images/i_plus-2-3.gif' align='absmiddle'>" + folderImgStr);
            } else { // 不是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_plus2-1.gif' align='absmiddle'>" + folderImgStr);
                else
                    out.println("<img src='../netdisk/images/i_plus-2-2.gif' align='absmiddle'>" + folderImgStr);
            }
        }
...
*/
    ...
    void ShowLeaf(JspWriter out, Leaf leaf,
        ...
        if (leaf.getCode().equals(rootLeaf.getCode())) { // 如果是根结点
            out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_puls-root.gif' align='absmiddle'><img src='../netdisk/images/folder_01.gif' align='absmiddle'>");
        } else {
            if (isLastChild) { // 是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_plus2-2.gif' align='absmiddle'><img src='../netdisk/images/folder_01.gif' align='absmiddle'>");
                else
                    out.println("<img src='../netdisk/images/i_plus-2-3.gif' align='absmiddle'><img src='../netdisk/images/folder_01.gif' align='absmiddle'>");
            } else { // 不是最后一个孩子结点
                if (childcount > 0)
                    out.println("<img onClick=\"ShowChild(this, '" + tableid + "')\" src='../netdisk/images/i_plus2-1.gif' align='absmiddle'><img src='../netdisk/images/folder_01.gif' align='absmiddle'>");
                else
                    out.println("<img src='../netdisk/images/i_plus-2-2.gif' align='absmiddle'><img src='../netdisk/images/folder_01.gif' align='absmiddle'>");
            }
        }
