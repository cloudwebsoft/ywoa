...
public class Directory {
    ...
    public boolean AddChild(HttpServletRequest request) throws
        ...
        String pvg = ParamUtil.get(request, "pvg");
        String icon = ParamUtil.get(request, "icon");
        boolean use = ParamUtil.get(request, "isUse").equals("1");
        ...
        boolean canRepeat = ParamUtil.getInt(request, "canRepeat", 0)==1;

        String bigIcon = ParamUtil.get(request, "bigIcon");

        boolean isWidget = ParamUtil.getInt(request, "isWidget", 0)==1;
        ...
        lf.setLink(link);
        if (!preCode.equals("")) {
            if (preCode.equalsIgnoreCase("module"))
                lf.setType(Leaf.TYPE_MODULE);
            else if (preCode.equalsIgnoreCase("flow"))
            	lf.setType(Leaf.TYPE_FLOW);
            else if (preCode.equalsIgnoreCase("basicdata")) {
            	lf.setType(Leaf.TYPE_BASICDATA);
            }
            else
        ...
        lf.setCanRepeat(canRepeat);
        lf.setBigIcon(bigIcon);
        lf.setWidget(isWidget);
    ...
    public synchronized boolean update(HttpServletRequest request) throws
        ...
        if (!preCode.equals("")) {
            if (preCode.equalsIgnoreCase("module"))
                leaf.setType(Leaf.TYPE_MODULE);
            else if (preCode.equalsIgnoreCase("flow"))
            	leaf.setType(Leaf.TYPE_FLOW);        
            else if (preCode.equalsIgnoreCase("basicdata")) {
            	leaf.setType(Leaf.TYPE_BASICDATA);
            }
            else
        ...
        leaf.setCanRepeat(canRepeat);
        leaf.setBigIcon(bigIcon);
        leaf.setWidget(isWidget);
