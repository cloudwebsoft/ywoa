...
public class Leaf implements Serializable,ITagSupport {
    ...
    public static String SCRIPTS_DOWNLOAD_VALIDATE = "download_validate";
    public static String SCRIPTS_DOWNLOAD = "download";
    public static String SCRIPTS_ADD = "add";
    public static String SCRIPTS_DEL = "del";
    ...
    final String LOAD = "select code,name,description,parent_code,root_code,orders,layer,child_count,add_date,islocked,type,isHome,doc_id,template_id,pluginCode,IS_SYSTEM,target,is_show,is_office_ntko_show,is_log,is_fulltext,is_examine,scripts,id from directory where code=?";
    ...
    public synchronized boolean update() {
        ...
        String sql = "update directory set name=" + StrUtil.sqlstr(name) +
                     ...
                     ",is_show=" + (show?1:0) + ",is_office_ntko_show=" + (OfficeNTKOShow?1:0)+",is_log="+(log?1:0) + ",is_fulltext=" + (fulltext?1:0) + ",is_examine=" + (examine?1:0) + ",scripts=" + StrUtil.sqlstr(scripts) + " where code=" + StrUtil.sqlstr(code);
        // logger.info(sql);
    ...
    public synchronized boolean update(String newParentCode) throws ErrMsgException {
        ...
        String sql = "update directory set name=" + StrUtil.sqlstr(name) +
                     ...
                     ",is_show=" + (show?1:0) + ",is_office_ntko_show=" + (OfficeNTKOShow?1:0)+",is_log="+(log?1:0) + ",is_fulltext=" + (fulltext?1:0) + ",is_examine=" + (examine?1:0) + " where code=" + StrUtil.sqlstr(code);
    ...
    public boolean AddChild(Leaf childleaf) throws
        ...
        String insertsql = "insert into directory (code,name,parent_code,description,orders,root_code,child_count,layer,type,add_date,IS_SYSTEM,isHome,target,is_show,is_office_ntko_show,is_log,is_fulltext,is_examine) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        Conn conn = new Conn(connname);
        try {
            //更改根结点的信息
