...
public class Attachment implements java.io.Serializable {
    ...
    String LOAD = "SELECT doc_id, name, fullpath, diskname, visualpath, orders, page_num, downloadCount, upload_date, file_size, ext, is_embedded FROM document_attach WHERE id=?";
    ...
    public boolean create() {
        ...
        String sql =
            "insert into document_attach (fullpath,doc_id,name,diskname,visualpath,page_num,orders,id,upload_date,file_size,ext,is_embedded) values (?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 // 预览图片左右翻(public)
    ...
    public void loadFromDbByOrders() {
        ...
        ResultSet rs = null;
        try {
            String LOADBYORDERS = "SELECT id, name, fullpath, diskname, visualpath,downloadCount,ext FROM document_attach WHERE orders=? and doc_id=? and page_num=?";
