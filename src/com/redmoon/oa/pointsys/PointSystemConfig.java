...
public class PointSystemConfig {
    ...
    private final String CONFIG_FILENAME = "config_point_system.xml";
    ...
    public static PointSystemConfig cfg = null;
    private static Object initLock = new Object();

    public Vector assessLevels;

    public PointSystemConfig() {
    }

    @SuppressWarnings("deprecation")
	public void init() {
        logger = Logger.getLogger(PointSystemConfig.class.getName());
