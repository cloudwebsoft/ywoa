...
public class DocCacheMgr implements ICacheMgr {
    ...
    public final static String FULLTEXT = "NETDISK_FULLTEXT"; // 用于全文检索，使用SQLServer的全文检索
    public final static String ALL = "NETDISK_ALL";   // 用于搜索，使用like %...%
    String COUNT_GROUP_NAME = "NETDISK_SQL_COUNT_";
    String DOCBLOCKCACHEPRIX = "NETDISK_DOCBLOCK_";
    String cachePrix = "netdisk_doc";

    public final static String CHILDREN_OF_PARENT = "NETDISK_CHILDREN_"; // 用于在首页列表显示一个目录下所有子目录中的文章，这种方法不能包含该目录下的文章，只能是子目录中的文章
    ...
    public void refreshFulltext() {
        try {
            ...
            logger.error("refreshFulltext:" + e.getMessage());
        }
    }
