...
public class Config {
    ...
    boolean debug = true;
    final String configxml = "config_tigase.xml"; //同步配置文件
    String xmlpath = "";
    Document doc = null;
    Element root = null;
    ...
    public String getDescription(String name) {
        Element which = root.getChild("tigase").getChild(name);
    ...
    public int getInt(String elementName) {
        Element which = root.getChild("tigase").getChild(elementName);
        if (which == null)
            return -1;
        int r = -1;
        try {
