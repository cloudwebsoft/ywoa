...
public class NetDiskDb {
			...
			for (int i = 0; i < dirs.length; i++) {
				...
				if (flag) {
					...
					if (parentCode.equals("-1")) {
						...
						documentBean.setTitle(isRoot ? "我的云盘" : "我的文档");
						directoryBean.setName(isRoot ? "我的云盘" : "我的文档");
	 ...
	 * 列出所有的云盘文件
	 * 
	 * @task:需要增加字段以确定是否属于云盘，因为云盘根目录可配置为与根节点合并
	 * @return
	 */
