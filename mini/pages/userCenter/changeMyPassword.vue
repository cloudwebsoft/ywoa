	...
	<view class="page-pwd">
		<view class="cententPage">
			<view class="login-item heri-start-center" :class="{ is_red: isNotAllow }">
				...
				<input type="text" class="login-content" placeholder="请输入旧密码" v-model="loginInfo.oldPwd" @focus="isNotAllow = false" />
			</view>
			<view class="login-item heri-start-center" :class="{ is_red: isNotAllow }">
				<image src="../../static/login/login_lock_red.png" class="login-icon" v-if="isNotAllow"></image>
				<image src="../../static/login/login_lock.png" class="login-icon" v-else></image>
				<input type="text" class="login-content" placeholder="请输入新密码" v-model="loginInfo.pwd" @focus="isNotAllow = false" />
			</view>
			<!-- type="password" -->
			<view class="login-item heri-start-center" :class="{ is_red: isNotAllow }">
				<image src="../../static/login/login_lock_red.png" class="login-icon" v-if="isNotAllow"></image>
