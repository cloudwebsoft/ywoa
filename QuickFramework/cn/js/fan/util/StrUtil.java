...
public class StrUtil {
    ...
    public static float toFloat(String str, float defaultValue) {
        ...
        try {
            ...
            LogUtil.getLog(StrUtil.class).error("toFloat" + e.getMessage());
        }
        return d;
    }
    ...
    public static double toDouble(String str, double defaultValue) {
        ...
        try {
        	if (str != null && !str.trim().equals(""))   //增加null及空判断  modify by jfy 20150402
        		d = Double.parseDouble(str.trim());
        } catch (Exception e) {
            LogUtil.getLog(StrUtil.class).error("toDouble:" + StrUtil.trace(e));
        }
        return d;
    }
    ...
    public static int toInt(String str, int defaultValue) {
        ...
        try {
            ...
            // LogUtil.getLog(StrUtil.class).error( "toInt" + e.getMessage());
        }
        return d;
    }
