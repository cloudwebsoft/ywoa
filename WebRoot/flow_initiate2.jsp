...
<%=wfd.getTitle()%></TD>
  ...
  <TR valign="top" bgcolor="#FFFFFF">
	...
	<form name="addform" action="fwebedit_do.jsp" method="post">
            ...
            <tr align="center">
              <td colspan="2" align="left" valign="top" bgcolor="#F2F2F2" class="unnamed2">
<div id="idTemporary" name="idTemporary" style="display:none">
<%
...
<div id="divTemplate" name="divTemplate" style="display:none">
<%if (template!=null) {
	content = template.getContent(1);
%>
	<%=content%>
<%}%>
</div>
...
<script>
<%if (templateId!=-1) {%>	
	setHTML(document.getElementById("divTemplate").innerHTML);
<%}else{%>
	// alert(document.getElementById("idTemporary").innerHTML);
	setHTML(document.getElementById("idTemporary").innerHTML);
<%}%>
</script>              </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;
<input name="button22" type=button class="btn" onClick="table_create.style.display=''" value="创建文件">
