...
<table width="501" border="0" align="center" cellpadding="0" cellspacing="0" class="tabStyle_1">
  ...
  <tr>
    <td align="center"><select id="fieldsSelected" name="fieldsSelected" size=15 multiple style="width:200px;height:305px;" ondblclick="notsel();" >
	<%=selOptions%>
    </select>
    </td>
    ...
    <td align="center">
	<select id="fieldsNotSelected" name="fieldsNotSelected" size=15 multiple style="width:200px;height:305px;" ondblclick="sel();">
	<%=options%>
    </select>
    </td>
  </tr>
