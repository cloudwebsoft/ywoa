...
RTXConfig myconfig = RTXConfig.getInstance();
...
if (name!=null && !name.equals("")) {
	...
	out.println(fchar.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "config_rtx.jsp"));
	myconfig.reload();
	myconfig = RTXConfig.getInstance();	
	return;
}
%>
...
%>
  <form method="post" id="form<%=k%>" name="form<%=k%>" action='config_rtx.jsp'>
    <tr>
