...
<div id="tabs1">
  <ul>
    ...
    <a href="form_m.jsp?flowTypeCode=<%=StrUtil.UrlEncode(flowTypeCodeTop)%>"><span>流程表单列表</span></a>
    <%}else{ %>
    <a href="javascript:switchList(1)"><span>流程表单列表</span></a>
    <%} %>
    </li>
...
<%if (flowTypeCodeTop.equals("") && (com.redmoon.oa.kernel.License.getInstance().isPlatform() || com.redmoon.oa.kernel.License.getInstance().isPlatformSrc())) {%>
    <li id="menu3"><a href="javascript:switchList(0)"><span>模块表单列表</span></a></li>
<%}%>
