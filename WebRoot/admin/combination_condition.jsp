  ...
  <script type="text/javascript">
  	function add(){
  		...
  		cell.innerHTML = "<select name='firstBracket' id='firstBracket"+i+"'><option value=''></option><option value='('>(</option><option value=')'>)</option></select>&nbsp;<select name='fieldName' id='fieldName"+i+"' style='display:inline-block;' onchange='changeFieldName("+i+")'>"+fieldNameValue+
  		        ...
  		        "' style='display:inline'><input type='text' name='columnName' id='columnName"+i+"' value='' style='width:100px;'/></div>&nbsp;<select name='userRole' id='userRole"+i+"' style='display:none;width:155px;'>"+roleValue+
  		...
  		cell = row.insertCell();
  		cell.innerHTML = "<input type='button' value='添加' onclick='add()'/>&nbsp;&nbsp;&nbsp;<input type='button' value='删除 ' onclick='del(this)'/>";
	...
	function changeColumn(str){
		...
		if(columnValue == "<%=WorkflowPredefineDb.COMB_COND_TYPE_PRIV_ROLE%>"){
			...
			document.getElementById("userRole"+str).style.display="inline-block";
		...
		for(var i=0;i<len;i++){
			...
			if(obj != null){
				...
				if($("#mainColumn"+i).val() == "<%=WorkflowPredefineDb.COMB_COND_TYPE_PRIV_ROLE%>"){
					val = "<value>"+$("#userRole"+i).val()+"</value>";
				}
     ...
     <form action="" id="form" >
	     <table  id="tab" class="tabStyle_1 percent80"  border="0" align="center" cellpadding="2" cellspacing="0" >
	    	<tr style="border: 1px solid #a8a8a8;border-top:1px;border-bottom:1px">
	    		<td class="tabStyle_1_title" >&nbsp;主表字段</td>
	    	...
	    	<tr align="center">
	    		...
	    		<td width="40%" align="left">
	    			...
	    			<select name="userRole" id="userRole0" style="display:none;width:155px;">
	    				<% 
	    	...
	    	%>
	    		<tr align="center">
	    			...
	    			<select name="userRole<%=i %>" id="userRole<%=i %>" style="display:none;width:155px;">
	    				<% 
	    					RoleDb roleDb = new RoleDb();
	    					Iterator ir = roleDb.list().iterator();
	    					while(ir.hasNext()){
	    			...
	    			<script>
	    				o("userRole<%=i%>").value="<%=e.getChildText("value")%>";
	    			</script>
	    ...
	    <table  width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
     		<tr align="center">
     			...
     			<td colspan="3">
	     			...
	     			<input type="button" value="确定" onclick="clickSure()"/>
     			</td>
     		</tr>
     	</table>
    </form>
