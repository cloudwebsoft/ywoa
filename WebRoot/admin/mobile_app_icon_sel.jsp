...
%>
	<td>&nbsp;<img style="cursor:pointer;" onClick="changeface('<%=fileName%>')" alt='<lt:Label res="res.label.forum.user" key="check_selected"/>' src="<%=request.getContextPath()%>/images/mobileAppIcons/<%=fileViewer.getFileName()%>" border="0"/></td>		
<%
	k++;	
	if (k==10)
		out.write("</tr>");
