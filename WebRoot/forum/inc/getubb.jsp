...
<%@ taglib uri="/WEB-INF/tlds/LabelTag.tld" prefix="lt_ubb" %>
<img onclick=Cbold() src="images/UBB/bold.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="bold"/>" border="0"> 
<img onclick=Citalic() src="images/UBB/italicize.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="italic"/>" border="0"> 
<img onclick=Cunder() src="images/UBB/underline.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="underline"/>" border="0"> 
<img onclick=Ccenter() src="images/UBB/center.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="center"/>" border="0"> 
<img onclick=Curl() src="images/UBB/url1.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="link"/>" border="0"> 
<img onclick=Cemail() src="images/UBB/email1.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="link_email"/>" border="0"> 
<img onclick=Cimage() src="images/UBB/image.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="image"/>" border="0"> 
<img onclick=Cswf() src="images/UBB/swf.gif" width="23" height="22" alt="Flash" border="0"> 
<img onclick=Cdir() src="images/UBB/Shockwave.gif" width="23" height="22" alt="Shockwave" border="0"> 
<img onclick=Crm() src="images/UBB/rm.gif" width="23" height="22" alt="realplay" border="0"> 
<img onclick=Cwmv() src="images/UBB/mp.gif" width="23" height="22" alt="Media Player" border="0"> 
<img onclick=Cmov() src="images/UBB/qt.gif" width="23" height="22" alt="QuickTime" border="0"> 
<img onclick=Cquote() src="images/UBB/quote1.gif" width="23" height="22" alt="<lt_ubb:Label res="res.label.forum.inc.getubb" key="quote"/>" border="0"> 
<IMG onclick=Cfly() height=22 alt=<lt_ubb:Label res="res.label.forum.inc.getubb" key="text_fly"/> src="images/UBB/fly.gif" width=23 border=0> 
<IMG onclick=Cmarquee() height=22 alt=<lt_ubb:Label res="res.label.forum.inc.getubb" key="text_move"/> src="images/UBB/move.gif" width=23 border=0> 
<IMG onclick=Cguang() height=22 alt=<lt_ubb:Label res="res.label.forum.inc.getubb" key="text_glow"/> src="images/UBB/glow.gif" width=23 border=0> 
<IMG onclick=Cying() height=22 alt=<lt_ubb:Label res="res.label.forum.inc.getubb" key="text_shadow"/> src="images/UBB/shadow.gif" width=23 border=0> 
<br>
&nbsp;&nbsp;<lt_ubb:Label res="res.label.forum.inc.getubb" key="font"/>
...
<option value="宋体" selected><lt_ubb:Label res="res.label.forum.inc.getubb" key="songti"/></option>
<option value="楷体_GB2312"><lt_ubb:Label res="res.label.forum.inc.getubb" key="kaiti"/></option>
<option value="新宋体"><lt_ubb:Label res="res.label.forum.inc.getubb" key="newsongti"/></option>
<option value="黑体"><lt_ubb:Label res="res.label.forum.inc.getubb" key="heiti"/></option>
<option value="隶书"><lt_ubb:Label res="res.label.forum.inc.getubb" key="lishu"/></option>
...
&nbsp;&nbsp;
<lt_ubb:Label res="res.label.forum.inc.getubb" key="font_size"/><select name="size" onChange="if(this.options[this.selectedIndex].value!=''){showsize(this.options[this.selectedIndex].value);this.options[0].selected=true;}else {this.selectedIndex=0;}">
...
<lt_ubb:Label res="res.label.forum.inc.getubb" key="font_color"/>
