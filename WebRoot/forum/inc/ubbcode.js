...
function AddText(text) {
	if (document.frmAnnounce.Content.createTextRange
		...
		document.frmAnnounce.Content.value += text;
...
function fontchuli() {
	if ((document.selection) && (document.selection.type == "Text")) {
		...
		document.frmAnnounce.Content.value = fontbegin
				+ document.frmAnnounce.Content.value + fontend;
		document.frmAnnounce.Content.focus();
	}
}
...
function usePoint() {
	var ary = showModalDialog('point_sel.jsp', window.self,
			'dialogWidth:526px;dialogHeight:435px;status:no;help:no;');
	if (ary == null)
		return;
