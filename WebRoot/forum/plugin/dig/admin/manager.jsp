...
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<%=DigSkin.LoadString(request, "name")%></td>
  </tr>
</table>
<br>
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  <tr> 
    <td height=20 align="left" class="thead">管理 - <%=DigSkin.LoadString(request, "name")%></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center"><a href="config_dig.jsp">掘客配置</a></td>
      </tr>
    </table>
      <br>
...
<%}%>
	  ...
	  <form action="?op=addBoard" method=post>
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="44%" align="left"><input type=submit value="设为支持<%=DigSkin.LoadString(request, "name")%>功能"></td>
        </tr></form>
      </table>      <br>
    <br></td>
  </tr>
