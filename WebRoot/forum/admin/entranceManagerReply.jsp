...
if (op.equals("add")) {
	...
	if (!boardCode.equals("")) {
		String entranceCode = ManagerReplyEntrance.CODE;
...
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  <tr> 
    <td height=20 align="left" class="thead"> <lt:Label res="res.label.forum.admin.entrance" key="plugin_entrance"/> 
      - <%=SkinUtil.LoadString(request, "res.config.entrance", ManagerReplyEntrance.CODE)%></td>
  </tr>
  <tr> 
    <td valign="top"><br>
...
Vector v = br.list(ManagerReplyEntrance.CODE);
