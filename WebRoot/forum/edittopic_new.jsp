...
function changeAttachName(attach_id, msgId, nm, desc) {
	var obj = findObj(nm);
	var descObj = findObj(desc);
	...
	form3.newDesc.value = descObj.value;
	form3.submit();
}
...
<%}%>	</td>
  ...
  <lt:Label res="res.label.forum.addtopic" key="file"/>&nbsp;<input type="file" name="filename" size=10>&nbsp;<lt:Label res="res.label.forum.addtopic" key="att_desc"/>&nbsp;<input name="filenameDesc" />&nbsp;<lt:Label res="res.label.forum.addtopic" key="file_limit_count"/><%=maxAttachmentCount%>&nbsp;<lt:Label res="res.label.forum.addtopic" key="file_limit_all_size"/><%=maxAttachmentSize%>K
          ...
          <table width="98%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="96%">
                ...
                &nbsp;<lt:Label res="res.label.forum.addtopic" key="att_desc"/>
			  	&nbsp;<input name="attach_desc<%=am.getId()%>" value="<%=am.getDesc()%>" size="30">
                &nbsp;<a href="javascript:changeAttachName('<%=am.getId()%>', '<%=Topic.getId()%>', '<%="attach_name"+am.getId()%>', '<%="attach_desc"+am.getId()%>')"><lt:Label res="res.label.forum.edittopic" key="change_name"/></a>&nbsp;<a href="javascript:delAttach('<%=am.getId()%>', '<%=Topic.getId()%>')"><lt:Label res="res.label.forum.addtopic" key="del_attach"/></a>
				<%if (am.isRemote()) {%>
...
<form name="form3" action="?" method="post">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <input name="newDesc" type="hidden" />
        </td>
    </tr>
  </table>
</form>
