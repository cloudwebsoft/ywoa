...
<ul class="mui-table-view">
    <li class="mui-table-view-cell" style="text-align:center"><b><%=pd.getTitle() %></b><br></li>
    <li class="mui-table-view-cell">
    	<div class="mui-row">
		    <div class="mui-col-sm-2" style="width:30%; text-align:left;">开始时间</div>
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=bDate %></div>
	    </div>
    </li>
    <li class="mui-table-view-cell">
    	<div class="mui-row">
		    <div class="mui-col-sm-2" style="width:30%; text-align:left;">结束时间</div>
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=eDate %></div>
	    </div>
    </li>    
    <li class="mui-table-view-cell">
    	<div class="mui-row">
		    <div class="mui-col-sm-2" style="width:30%; text-align:left;">便笺</div>
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=pd.isNotepaper()?"是":"否" %></div>
	    </div>
    </li>        
    <li class="mui-table-view-cell">
    	<div class="mui-row">
		    <div class="mui-col-sm-2" style="width:30%; text-align:left;">状态</div>
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=pd.isClosed()?"<img id='imgStatus' src='../../images/task_complete.png' style='width:16px'>":"<img id='imgStatus' src='../../images/task_ongoing.png' style='width:16px'"%></div>
	    </div>
    </li>    
    <%
    ...
    <li class="mui-table-view-cell">
    	<div class="mui-row">
		    ...
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=pd.isShared()?"是":"否"%></div>
	    </div>
    </li>      
    <%} %>
    <li class="mui-table-view-cell">
	    <div class="mui-row">
		    ...
		    <div class="mui-col-sm-2" style="width:70%; text-align:left;"><%=createDate %></div>
	    </div>
    </li>    
    <li class="mui-table-view-cell"><%=pd.getContent() %></li>
</ul>
