...
<%@ page import="com.redmoon.oa.android.i.ResetPasswordAction" %>
<%
...
<script>
    function logout() {
        ...
        window.location.href = "../exit_oa.jsp?redirectUrl=wap/index.jsp";
    }
    ...
    $('.mui-btn').click(function() {
        ...
        var btnArray = ['确认', '取消'];
        mui.confirm('确认删除要修改么？', '提示', btnArray, function(e) {
            if(e.index == 0){
