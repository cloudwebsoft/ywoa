...
<div id="drag_<%=id%>" dragTitle="<%=udsd.getTitle()%>" count="<%=udsd.getCount()%>"
    ...
    <div id="drag_<%=id%>_h" class="box ibox-title">
        ...
        %>
        <h5>
            <i class="fa <%=udsd.getIcon()%>"></i>&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/ymoa/queryMyWeekWork.action?logType=1"><%=udsd.getTitle()%></a>
        </h5>
        <%
        }
        else {
        ...
        <div class="titleimg">
            ...
            &nbsp;&nbsp;</div>
        <div class="titletxt">&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/ymoa/queryMyWeekWork.action?logType=1"><%=udsd.getTitle()%></a></div>
        <%
            }
        %>
    </div>
