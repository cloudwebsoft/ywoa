...
<div id="drag_<%=id%>" dragTitle="<%=udsd.getTitle()%>" count="<%=udsd.getCount()%>" wordCount="<%=udsd.getWordCount()%>" class="portlet drag_div bor" >
   <div id="drag_<%=id%>_h" class="box">
    	...
    	<div class="titleimg">
        <!--<img src="images/desktop/mywork.week.png" width="40" height="40" />-->
      ...
      <% 
  	  ...
  	  <%
         ...
         wld = (WorkLogDb)ir.next();%>	
          ...
          <td class='article_time' style="width:135px">[<%=wld.getLogItem()%>周&nbsp;<%=DateUtil.format(wld.getMyDate(), "yyyy-MM-dd")%>]</td>
          </tr>
  	 	<%}%>
    	</table>	
    	<%}else{%>
