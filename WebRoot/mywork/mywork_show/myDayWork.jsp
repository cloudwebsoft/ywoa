...
<html>
  <head>
    <title><s:property value="pageTitle"/>的工作日报</title>
...
<!--日报时间选择-->
    <div class="mywork-list-time">
      ...
      <form id="queryFrm" name="queryFrm" action="<%=request.getContextPath()%>/ymoa/queryMyWorkForShow" method="post"  enctype="multipart/form-data">
      ...
      <form id="initForm" name="initForm" action="<%=request.getContextPath()%>/ymoa/showWorkLogInfo" method="post"  enctype="multipart/form-data">
