...
<!--日报时间选择-->
    <div class="mywork-list-time">
      <ul>
        ...
        <li style="list-style:none;"><input id="sendDate" name="sendDate" value="<s:property value="dateCond"/>" size=10  class='mywork-list-time-span2'/></li>
        <li class="mywork-list-time-span3" id="after" onclick="after()"></li>
        <li class="mywork-list-time-span4" onclick="returnToday()">返回今天</li>
        <%} %>
      </ul>
      <form id="queryFrm" name="queryFrm" action="<%=request.getContextPath()%>/ymoa/queryMyWork" method="post"  enctype="multipart/form-data">
      ...
      <form id="initForm" name="initForm" action="<%=request.getContextPath()%>/ymoa/myWorkManageInit" method="post"  enctype="multipart/form-data">
      		<input type="hidden" name="formCode" id="formCode"  value="<%=code %>"/>
    ...
    <s:iterator var="wl" value="list" status="statu">
      <div class="mywork-list-master">
          <div  id="mywork_<s:property value="#wl.id"/>">
	          <div id="datearea_<s:property value="#wl.id"/>" class="mywork-list-master-p1"><s:property value="#wl.myDate"/></div> 
