...
function openWinUsers() {
	...
	showModalDialog('../user_multi_sel.jsp?unitCode=<%=privilege.getUserUnitCode(request)%>',window.self,'dialogWidth:900px;dialogHeight:730px;status:no;help:no;')
}
...
<input class="btn" title="添加部门" onClick="openWinDepts()" type="button" value="添 加" name="button">
    ...
    <tr >
      ...
      <td><input name="principal" type="hidden" id="principal">
        ...
        &nbsp;
        <input class="btn" title="清空收件人" onClick="o('principalRealNames').value='';o('principal').value=''" type="button" value="清 空" name="button"></td>
    </tr>
    <tr >
      <td noWrap>参与人：</td>
      <td><input name="users" id="users" type="hidden">
        ...
        &nbsp;
        <input class="btn" title="清空人员" onClick="o('users').value='';o('userRealNames').value=''" type="button" value="清 空" name="button"></td>
    </tr>    
    <tr>
      <td noWrap>备注：</td>
