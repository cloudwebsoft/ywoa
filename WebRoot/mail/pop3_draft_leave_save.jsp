...
if (re) {
	...
	response.sendRedirect("list_draft.jsp?id=" + epd.getId() + "&box=" + MailMsgDb.TYPE_DRAFT + "&sender=" + mmm.getMailMsgDb().getSender()+"&subMenu="+subMenu+"&subMenuButton="+subMenuButton+"&isShowMessage=1");
