...
<table width="100%" align="center" class="p9">
  <form name="form1" enctype="MULTIPART/FORM-DATA" action="uploadimg.jsp?module=<%=module %>&op=upload&uploadSerialNo=<%=serialNo%>" method="post" onSubmit="return form1_onsubmit()">
    <tr>
