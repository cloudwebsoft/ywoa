...
<%
	...
	if (op.equals("forRefresh")) {
		...
		if (!nestFieldName.equals("") && !"".equals(parentFormCode)) {
		...
		if (isAutoSel) {
			...
			while (m.find()) {
				...
				if (fName.equals("cwsCurUser") || fName.equals("curUser") || fieldName.equals("curUserDept") || fieldName.equals("curUserRole") || fieldName.equals("admin.dept")) {
					continue;
				}
