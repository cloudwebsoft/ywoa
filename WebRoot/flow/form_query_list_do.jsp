...
function action(com,grid) {
	if (com=='饼图') {
		...
		<%
		sql = "select distinct condition_field_code from form_query_condition where query_id=" + id;
...
function doGetMapIDS() {
	map = new Map();
	// $(".cth input[type='checkbox'][value!='on'][checked=true]", queryTable.bDiv).each(function(i) {
	// jquery1.8.3得按以下写法
