...
Iterator ir = fdao.getAttachments().iterator();
  ...
  <tr>
	...
	<input class="btn" type="button" value=" 编辑 " onclick="window.location.href='customer_sales_order_edit.jsp?customerId=<%=customerId%>&id=<%=id%>&formCodeRelated=<%=formCodeRelated%>&formCode=<%=formCode%>&isShowNav=1';" />
	<%}%>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" class="btn" onclick="window.open('sales_order_fahuodan.jsp?orderId=<%=fdao.getId()%>')" value="生成发货单"/>
    </td>
  </tr>
</table>
