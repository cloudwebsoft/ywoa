...
<form id="form2" name="form2" action="?op=search" method="post">
  <table class="tabStyle_1 percent60" cellspacing="0" cellpadding="0" width="100%" border="0">
    <tbody>
      <tr>
...
<table class="tabStyle_1 percent98" width="98%" border="0" align="center" cellpadding="2" cellspacing="1">
  ...
  <tr align="center">
    ...
    <td width="17%"><a href="product_service_edit.jsp?id=<%=id%>&amp;formCode=<%=StrUtil.UrlEncode(formCode)%>">编辑</a>&nbsp;&nbsp;<a href="../visual_del.jsp?id=<%=id%>&amp;formCode=<%=formCode%>&amp;privurl=<%=StrUtil.getUrl(request)%>">删除</a>&nbsp;&nbsp; </td>
  </tr>
  <%
		}
%>
