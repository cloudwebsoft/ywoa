...
<%}
	...
	out.print("<BR>");
%>
<form action="customer_sales_chance_edit.jsp?op=saveformvalue&customerId=<%=customerId%>&parentId=<%=parentId%>&id=<%=id%>&formCodeRelated=<%=formCodeRelated%>&formCode=<%=StrUtil.UrlEncode(formCode)%>&isShowNav=<%=isShowNav%>" method="post" enctype="multipart/form-data" name="visualForm" id="visualForm">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center"><table style="width:98%" align="center"><tr><td><script>initUpload()</script></td></tr></table></td>
    </tr>
    <tr>
      <td align="left"><%
