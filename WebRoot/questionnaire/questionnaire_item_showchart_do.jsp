...
Object[][] attr = null;
String sql = "select name,count(subitem_value) total"
	+ " from oa_questionnaire_form_subitem a,oa_questionnaire_subitem b" 
	+ " where a.id=b.subitem_value and a.item_id=" + itemId
	+ " group by subitem_value";
try {
