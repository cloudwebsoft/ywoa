...
<%
	...
	if (!"".equals(mainFormCode)) {
		...
		Iterator irNext = mainfd.getFields().iterator();
		while (irNext.hasNext()) {
			FormField ff = (FormField) irNext.next();
			if(!ff.getType().equals("DATE")) {
...
<%
	  ...
	  if(!condition.equals("")){
		  ...
		  // System.out.println(getClass() + " " + condition);
		  try {
  ...
  <script type="text/javascript">
    var map = new Map();
  	...
  	function add(){
		...
		html += $('#templet').html();
  		html += "&nbsp;<select name='userRole' id='userRole"+i+"' style='display:none;width:155px;'>"+roleValue+
