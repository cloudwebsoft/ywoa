...
<div id="tabs1">
  <ul>
    <li id="menu1"><a href="module_list_nest_sel.jsp?parentFormCode=<%=parentFormCodeTop%>&nestFieldName=<%=nestFieldNameTop%>&nestType=<%=nestTypeTop%>&parentId=<%=parentIdTop%>"><span><%=msdTop.getString("name")%>列表</span></a></li>
    <%
