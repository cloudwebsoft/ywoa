...
<%}%>
<form action="?op=saveformvalue&amp;id=<%=id%>&amp;formCode=<%=StrUtil.UrlEncode(formCode)%>&isShowNav=<%=isShowNav%>&parentId=<%=parentId%>&menuItem=<%=menuItem %>" method="post" enctype="multipart/form-data" name="visualForm" id="visualForm">
