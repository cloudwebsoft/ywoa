...
<body>
<form name="form1" action="nest_sheet_import_excel.jsp?op=add&moduleCode=<%=moduleCode%>&formCode=<%=StrUtil.UrlEncode(formCode)%>&parentId=<%=parentId %>" method="post" encType="multipart/form-data">
