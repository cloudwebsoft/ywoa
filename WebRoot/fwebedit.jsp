...
<style type="text/css">
<!--
.head1{ background-color: #daeaf8; height: 23px; font-size: 14px; font-weight: bold; color: #666666; padding: 8px 0px 0px 5px;border-bottom:2px solid #92b4d2;}
    ...
    <TD width="" height="430" colspan="2" style="background-attachment: fixed; background-image: url(images/bg_bottom.jpg); background-repeat: no-repeat">
		...
		if (typeof(window.parent.leftFileFrame)=="object"){
			...
			document.write("</span></a>");
                ...
                <TD width="10%" align="right" class="head1"><a href="fwebedit_new.jsp?op=<%=op%>&id=<%=id%>&dir_code=<%=StrUtil.UrlEncode(dir_code)%>&dir_name=<%=StrUtil.UrlEncode(dir_name)%>">普通方式</a>&nbsp;&nbsp;</TD>
              </TR>
            </TBODY>
          </TABLE>
