...
if (op.equals("addReply")) {
	...
	if(flag){
		...
		noticeReplyDb = noticeReplyDb.getReply();
		...
		json.put("replyId",noticeReplyDb.getId());//获得replyId
		json.put("res",0);
