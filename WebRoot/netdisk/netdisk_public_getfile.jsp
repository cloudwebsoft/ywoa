...
PublicAttachment att = new PublicAttachment(id);
...
String url, urlUTF8, realPath;
if (att.getAttId()!=0) {
	Attachment at = new Attachment();
	at = at.getAttachment(att.getAttId());
	url = Global.getFullRootPath(request) + "/" + file_netdisk + "/" + at.getVisualPath() + "/" + at.getDiskName();
	urlUTF8 = Global.getFullRootPath(request) + "/" + file_netdisk + "/" + at.getVisualPath() + "/" + URLEncoder.encode(at.getDiskName(), "UTF-8");
	realPath = Global.getRealPath() + file_netdisk + "/" + at.getVisualPath() + "/" + at.getDiskName();
}
else {
	url = Global.getFullRootPath(request) + "/" + file_netdisk_public + "/" + att.getVisualPath() + "/" + att.getDiskName();
	urlUTF8 = Global.getFullRootPath(request) + "/" + file_netdisk_public + "/" + att.getVisualPath() + "/" + URLEncoder.encode(att.getDiskName(), "UTF-8");
...
} else if (ext.equals("wmv") || ext.equals("asf") || ext.equals("avi") || ext.equals("mp4") || ext.equals("mp3") || ext.equals("mpeg") || ext.equals("wma") || ext.equals("mpg")) {
%><table width="100%" align="center"><tr><td align="center">
<object classid="clsid:22D6F312-B0F6-11D0-94AB-0080C74C7E95" id="MediaPlayer1" width="428" height="330">
        ...
        <param name="Filename" value="<%=urlUTF8%>">
