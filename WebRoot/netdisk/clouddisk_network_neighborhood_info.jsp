...
%>
  <frame src="clouddisk_network_neighborhood_dir.jsp?shareUser=<%=StrUtil.UrlEncode(shareUser)%>" frameborder="0" border="0" name="leftFileFrame" >
<%}
else {
%>
...
%>
  <frame src="netdisk_left.jsp?mode=<%=mode%>&dir_code=<%=dir_code %>" name="leftFileFrame" frameborder="0" border="0">
<%}%>
  <frame src="netdisk_main.jsp?op=<%=op%>&mode=<%=mode%>&dir_code=<%=dir_code %>&name=<%=name %>" name="mainFileFrame" frameborder="0" border="0">
</frameset>
<noframes><body>
</body></noframes>
</html>
