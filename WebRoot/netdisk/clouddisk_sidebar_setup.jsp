  ...
  <head>
	...
	<script type="text/javascript" src="../js/jquery.toaster.netdisk.js"></script> 
   	<style type="text/css">	
   		span{font-size:14px}
	    .picture{
			float:left;margin-right:11px;margin-top:13px;padding-left:20px;
		}
		.fireFoxOpacity{-moz-opacity:0.4;opacity:0.4}
		.note{width:695px;height:25px;background:#fffae0;border:2px solid #f2e9b7;margin-top:24px;margin-left:25px;margin-bottom:15px;font-famliy:"微软雅黑";color:red;text-align:center;font-size:13px;padding:25px 10px;}
		.sidebarDiv{height:215px; width:215px;background:#fff;margin-left:25px;float:left;border:1px solid #e6e6e6;background:#fff}
		.sidebarEdit{display:block;float:left;background:#336699;width:500px;height:215px;border:1px solid #e6e6e6;background:#fff}
		.isShow{height:20px;padding-left:15px;height:44px;padding-top:27px;border-bottom:1px solid #e6e6e6}
		.repTitle{font-famliy:"微软雅黑";font-size:15px;color:#333;float:left;padding-left:10px;width:120px;}
		.title1{margin-left:30px;float:left;width:100px;font-famliy:"微软雅黑";}
		.title2{margin-left:30px;float:left;width:200px;font-famliy:"微软雅黑";}
		.appDivSub{width:70px; height:30px;padding-top:5px;background:#4393f1;color:#fff;float:left;margin-left:25px;font-famliy:"微软雅黑";font-size:15px;padding-left:30px;}
		.editDiv{display:none;float:left;background:#eff4f5;width:500px;height:215px;border:1px solid #b4dbf5;}
		.editTitle{font-famliy:"微软雅黑";font-size:18px;color:#4392f2;height:35px;padding-top:5px;border-bottom:1px solid #b4dbf5;text-align:center;}
		.sideTitle{font-famliy:"微软雅黑";font-size:15px;color:#333;float:left;padding-left:25px;width:80px;}
		.editItem{height:30px;padding-top:5px;float:left}
		.buttonEdit{float:left;background:#b4dbf5;border:1px solid #88caf7;width:40px;height:18px;padding-left:10px;margin-left:10px;line-height:1}
		.selectEdit{float:left; margin-left:10px;}
		.editDivSub{width:45px; height:23px;background:#5cace6;border:1px solid #4799d6; color:#fff;float:left;margin-left:25px;font-famliy:"微软雅黑";font-size:13px;padding-left:20px;margin-left:135px;}
		.editDivCel{width:45px; height:23px;background:#5cace6;border:1px solid #4799d6; color:#fff;float:left;margin-left:25px;font-famliy:"微软雅黑";font-size:13px;padding-left:20px;}
   		.cbox{background:url('images/clouddisk/checkbox_1.png');float:left;width:20px;height:20px;margin-top:-2px;margin-left:-3px;}
   		.notice_topic,.showNotice,.upDiv{display:none;}
   		.is_show{background:url('images/clouddisk/radio_1.png');float:left;width:12px;height:12px;margin-top:4px;margin-left:2px;}
   		.turn{background:url('images/clouddisk/radio_1.png');float:left;width:12px;height:12px;margin-top:4px;margin-left:2px;}
    </style>
     <%	
