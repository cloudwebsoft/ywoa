...
<table width="100%"  border="0" style="background-image:url(images/bg_left.jpg); background-repeat:no-repeat">
  <tr>
    <td height="73" align="left"><table width="100%"  border="0">
      <tr>
        <td height="25" align="left" style="FILTER: glow(color=ffffff)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#0099FF">回收站</font></strong></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="left">&nbsp;<img src="images/network.gif" align="absmiddle">&nbsp;<a href="netdisk_neighbor_frame.jsp" target="_parent">网上邻居</a>&nbsp;&nbsp;<img src="images/folder_share.gif" width="16" height="16" align="absmiddle">&nbsp;<a href="netdisk_kp_share_frame.jsp" target="_parent">分享管理</a></td>
      </tr>
    </table></td>
  </tr>
</table>
