...
<table width="100%"  border="0">
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left"><%=ud.getRealName()%>的共享目录</td>
  </tr>
  <tr>
...
<%
Leaf leaf = new Leaf();
Iterator ir = leaf.listSharedDirOfUser(userName).iterator();
while (ir.hasNext()) {
	leaf = (Leaf)ir.next();
%>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="20" height="22"><img src="images/folder_share.gif" align="absmiddle"></td>
    <td><a href="dir_list.jsp?dir_code=<%=leaf.getCode()%>&op=editarticle" target="mainFileFrame" title="<%=leaf.getDescription()%>"><%=leaf.getName()%></a></td>
  </tr>
</table>
<%}%>  </td>
  </tr>
