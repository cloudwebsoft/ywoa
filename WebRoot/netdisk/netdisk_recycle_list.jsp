...
String sql = "select id from netdisk_document_attach where is_deleted=1 order by id desc";
...
<table cellSpacing="0" cellPadding="0" width="100%">
  <tbody>
    <tr>
      <td class="tdStyle_1">这里列出了您删除的文件
	  </td>
    </tr>
  </tbody>
</table>
...
<table width="767" class="tabStyle_1 percent98">
  <tbody>
    <tr>
      ...
      <td width="34%" class="tabStyle_1_title">文件名</td>
      <td width="10%" class="tabStyle_1_title">大 小</td>
      <td width="20%" class="tabStyle_1_title">目 录</td>
      <td width="16%" class="tabStyle_1_title">删除日期</td>
      <td width="20%" class="tabStyle_1_title">操 作</td>
    </tr>
...
while (ir.hasNext()) {
    ...
    <tr class="highlight">
      ...
      <td align="center"><%=DateUtil.format(pse.getDeleteDate(), "yy-MM-dd HH:mm")%></td>
      <td align="center"><a target="_blank" href="netdisk_doc_downloadfile.jsp?id=<%=pse.getId()%>&type=1">恢复</a></td>
    </tr>
<%}%>
  </tbody>
</table>
