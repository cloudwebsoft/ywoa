...
(function($) {
    ...
    $.fn.flexbox.defaults = {
        ...
        noResultsText: '未找到匹配项', // text to show when no results match the query
        ...
        width: 150, // total width of flexbox.  auto-adjusts based on showArrow value
	...
	$.fn.setIdValue=function(b){var c="#"+this.attr("id");a(c+"_hidden").val(b).removeClass("watermark")};	
	
    $.fn.getValue = function(val) {
        return $("input[name=" + this.attr('id') + "]").val();
    };	
