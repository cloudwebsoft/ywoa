                ...
                if (radioboxs!=null) {
                    ...
                    for (i=0; i < arr.length; i++) {
                        if (arr[i].value==ctlValue)
                            arr[i].outerHTML = "<span id='" + name + "_show'><img src='<%=rootpath%>/images/radio_y.gif' align='absMiddle'></span>";
                        else
                            arr[i].outerHTML = "<span id='" + name + "_show'><img src='<%=rootpath%>/images/radio_n.gif' align='absMiddle'></span>";
                    }
                }
            }
			else {
