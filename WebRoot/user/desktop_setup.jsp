...
<script>
	form<%=k%>.td.value = "<%=udsd.getTd()%>";
		...
		<td align="center">
			...
			if (canDelete) {
			%>
			<input class="btn" value="删除" type="button" onClick="jConfirm('您确定要删除么？','提示',function(r){if(!r){return;}else{ window.location.href='desktop_setup.jsp?op=del&id=<%=udsd.getId()%>&portalId=<%=portalId%>'}}) " />
            <%}%>
            <%if (ptd.isSystem()) {%>
...
<table width="100%" class="percent98" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
   	  <td width="33%" valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
        <form action="desktop_setup.jsp?op=add" method="post">
          ...
          <tr>
            <td align="left">图标</td>
            <td align="left">
              <select id="icon" name="icon" style="width:150px" class="desktop-icon js-example-templating js-states form-control">
				<%=iconOpts%>
              </select>         
            </td>
          </tr>
          <%}%>
          <tr>
            <td colspan="2" align="center"><input name="submit442" type="submit" class="btn" value="添加"/></td>
          </tr>
        </form>
    </table></td>
        <td width="33%" valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          ...
          <tr>
            ...
            <tr>
              <td colspan="2" align="center"><input name="submit44" type="submit" class="btn" value="添加"/></td>
            </tr>            
          </form>
        </table></td>
        <td width="34%" valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          <form action="desktop_setup.jsp?op=add" method="post">
            <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
...
<table width="100%" border="0" align="center" class="tabStyle_1 percent98">
        ...
        <td valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          <form id="formFileark" action="desktop_setup.jsp?op=add" method="post">
            ...
            <tr>
              <td align="left">&nbsp;目录</td>
              <td align="left">
              <select name="moduleItem" onchange="if(this.options[this.selectedIndex].value=='not'){jAlert(this.options[this.selectedIndex].text+' 不能被选择！','提示');return false;} else {formFileark.title.value=this.options[this.selectedIndex].text}">
        ...
        <td valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          <form name="formDoc" action="desktop_setup.jsp?op=add" method="post">
            ...
            <tr>
              <td align="left">&nbsp;编号</td>
              <td align="left">
                <select name="moduleItem" onchange="if(this.options[this.selectedIndex].value=='not'){jAlert(this.options[this.selectedIndex].text+' 不能被选择！','提示');return false;} else {formDoc.title.value=this.options[this.selectedIndex].text}">
                  <option value="not" selected="selected">请选择目录</option>
                  <%
					dv.ShowDirectoryAsOptions(out, lf, lf.getLayer());
				  %>
      ...
      <td valign="top"><table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          <form name="formModule" action="desktop_setup.jsp?op=add" method="post">
            ...
            <tr>
              <td align="left">&nbsp;名称</td>
              <td align="left"><select name="moduleCode" onchange="if (this.value=='') formModule.title.value=''; else formModule.title.value=this.options[this.selectedIndex].text">
			  ...
			  %>
			  <option value="<%=du.getCode()%>"><%=du.getName()%></option>
			  <%
			  }
			  %>
			  </select></td>
          ...
          <tr>
            ...
            <tr>
              <td colspan="2" align="center"><input name="submit4222" type="submit" class="btn" value="添加"/></td>
            </tr>
          </form>
        </table></td>
        <td valign="top">
<table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          ...
          <tr>
            ...
            <td align="left">
              ...
              <tr>
                <td colspan="2" align="center"><input name="submit432" type="submit" class="btn" value="添加"/></td>
              </tr>
            </form>
          </table>		
		</td>
        ...
        <table width="100%" border="0" align="center" class="tabStyle_1 percent98">
          <form id="formFlashImg" action="desktop_setup.jsp?op=add" method="post">
            ...
            <tr>
              <td align="left">&nbsp;名称</td>
              <td align="left">
              <select name="moduleItem" onchange="formFlashImg.title.value=this.options[this.selectedIndex].text">
      		  <%
			  ...
			  while (irFlashImg.hasNext()) {
				  ...
				  %>
					<option value="<%=pd.getLong("id")%>"><%=pd.getString("name")%></option>
				  <%
			  }	  
			  %>
              </select>
		...
		<table width="100%" border="0" align="center" class="tabStyle_1 percent98" style="display:none">
          <form id="formForum" action="desktop_setup.jsp?op=add" method="post">
            ...
            <tr>
              <td align="left">&nbsp;版块</td>
              <td align="left">
                  <select name="moduleItem" onchange="if(this.options[this.selectedIndex].value=='not') {jAlert('请选择版块！','提示'); this.value='';} else {formForum.title.value=this.options[this.selectedIndex].text;}">
...
<form id="formDesktopCode" name="formDesktopCode" action="desktop_setup.jsp?op=modifyCode&portalId=<%=portalId %>" method="post" enctype="multipart/form-data">
<table width="100%" align="center" class="tabStyle_1"><tr>
  <td colspan="2" class="tabStyle_1_title">桌面代码</td></tr>
  <tr>
    <td width="10%">天气代码</td>
    <td width="90%">
