...
fileViewer.init();
%>
<table style="border: solid 2px #bfcee3" width=80% cellpadding="0" cellspacing="0" ><center>
...
%>
	<td class="borderClass1" onmouseout="this.className='borderClass1'" onmouseover="this.className='borderClass2'">&nbsp;<img style='cursor:hand' onClick="changeface('<%=fileName%>')" alt='<lt:Label res="res.label.forum.user" key="check_selected"/>' src="../forum/images/face/<%=fileViewer.getFileName()%>" width="32" height="32" border="0"/></td>		
<%
	k++;	
	if (k==10)
		out.write("</tr>");
