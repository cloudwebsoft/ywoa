...
<%
	...
	if (!wfp.isReactive()) {
		if (wa.getStatus() != wa.STATE_DOING
				&& wa.getStatus() != wa.STATE_RETURN) {
...
/*
	...
	jConfirm(content, '<lt:Label res="res.flow.Flow" key="prompt"/>', function(r) {
    	if (r) {
			$.ajax({
				async: false,
				type: "post",
        ...
        <div id="editorBox" class="leftbox-1">
          <div class="box" style="margin-bottom:5px;">
            ...
            <div class="span3" style="display:none;"> 
              <%
				boolean flowAutoMsgRemind = cfg
						.getBooleanProperty("flowAutoMsgRemind");
