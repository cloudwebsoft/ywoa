...
public class DocContentCacheMgr implements ICacheMgr {
    ...
    String DOCCONTENTBLOCKCACHEPRIX = "DOCCONTENTBLOCK";
    String cachePrix = "doc_content_";
    String COUNT_GROUP_NAME = "CONTENT_COUNT_";
    ...
    public int getContentCount(int docId) {
        //根据sql语句得出计算总数的sql查询语句
        String query = "select count(*) from doc_content where doc_id=" + docId;
