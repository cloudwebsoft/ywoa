...
public class UEditorCtl extends AbstractMacroCtl {
    ...
    public String convertToHTMLCtl(HttpServletRequest request, FormField ff) {
        ...
        if (!"show".equals(pageType) && ff.isEditable()) {
            ...
            str += "<script src='" + request.getContextPath() + "/flow/macro/macro_ueditor_ctl_js.jsp?pageType=" + pageType + "&flowId=" + flowId + "&id=" + id + "&formCode=" + ff.getFormCode() + "&fieldName=" + StrUtil.UrlEncode(ff.getName()) + "'></script>";
        }
        return str;
    }
