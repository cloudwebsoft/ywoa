...
public class DocContentCacheMgr implements ICacheMgr {
    ...
    String DOCCONTENTBLOCKCACHEPRIX = "NETDISK_DOCCONTENTBLOCK";
    String cachePrix = "netdisk_doc_content_";
    String COUNT_GROUP_NAME = "NETDISK_CONTENT_COUNT_";
    ...
    public int getContentCount(int docId) {
        //根据sql语句得出计算总数的sql查询语句
        String query = "select count(*) from netdisk_doc_content where doc_id=" + docId;
