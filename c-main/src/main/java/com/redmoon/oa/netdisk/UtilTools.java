...
public class UtilTools {
	...
	public static HashMap<String, Boolean> getExtType(String type) {
		com.redmoon.clouddisk.Config rcfgImg = com.redmoon.clouddisk.Config.getInstance();
	 ...
	 * @return
	 */
	public static JSONObject getLayerByDir(String absolutePath, String name, JSONObject json) {
		int layer;
		try {
	...
	public static String ShowMenuAsOption(HttpServletRequest request) {
		...
		Vector<MostRecentlyUsedMenuDb> v = mrum.getMenuBeingStored(privilege
				.getUser(request));
		String[] clouddiskMenu = new String[] { "我的网盘", "我发起的协作", "我参与的协作",
				"回收站", "资源库" };
		sb.append("<option value=\"oa.jsp\">网盘首页</option>");
		sb
