...
public class SendEmailJob extends QuartzJobBean {
	...
	public void executeInternal(JobExecutionContext arg0) throws JobExecutionException {
		...
		String sql_query = "select id from "+tableName+ " where msg_type = "+MailMsgDb.TYPE_DRAFT+" and send_time <= "+SQLFilter.getDateStr(DateUtil.format(now, "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss");
