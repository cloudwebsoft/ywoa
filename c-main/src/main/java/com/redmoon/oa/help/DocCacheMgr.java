...
public class DocCacheMgr implements ICacheMgr {
    ...
    public final static String ALL = "HELP_ALL"; // 用于搜索，使用like %...%
    String COUNT_GROUP_NAME = "HELP_SQL_COUNT_";
    String DOCBLOCKCACHEPRIX = "HELP_DOCBLOCK_";
    String cachePrix = "doc";

    public final static String CHILDREN_OF_PARENT = "HELP_CHILDREN_"; // 用于在首页列表显示一个目录下所有子目录中的文章，这种方法不能包含该目录下的文章，只能是子目录中的文章
