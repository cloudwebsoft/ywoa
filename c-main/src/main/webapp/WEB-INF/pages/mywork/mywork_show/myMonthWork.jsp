...
<div class="mywork-list-wrap">
    ...
    <div class="mywork-list-time">
        ...
        <form id="queryFrm" name="queryFrm" action="<%=request.getContextPath()%>/mywork/queryMyMonthWorkForShow" method="post" enctype="multipart/form-data">
