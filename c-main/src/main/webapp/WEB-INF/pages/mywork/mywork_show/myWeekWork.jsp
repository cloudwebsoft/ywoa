...
<div class="mywork-list-wrap">
    ...
    <div class="mywork-list-time-week">
        ...
        <form id="queryFrm" name="queryFrm" action="<%=request.getContextPath()%>/mywork/queryMyWeekWorkForShow" method="post">
    ...
    <c:forEach items="${list}" var="wl" varStatus="statu">
        <div class="mywork-list-master">
            <div id="mywork_${wl.id}">
                <div class="mywork-list-master-p1">${wl.showTitle}</div>
...
<script type="text/javascript">
    ...
    function returnToday() {
        window.location.href = "queryMyWeekWorkForShow?logType=${logType}&userName=" + encodeURI("${userName}");
    }
