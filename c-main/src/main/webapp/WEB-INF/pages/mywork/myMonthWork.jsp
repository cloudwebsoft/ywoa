...
<div class="mywork-list-wrap">
    ...
    <div class="mywork-list-time">
        <ul>
            ...
            <li style="list-style:none;" class="mywork-list-time-span2">${dateCond}</li>
            <li class="mywork-list-time-span3" id="after" onclick="after()"></li>
            <li class="mywork-list-time-span4" onclick="returnToday()">返回本月</li>
            <%} %>
        </ul>
        <form id="queryFrm" name="queryFrm" action="<%=request.getContextPath()%>/mywork/queryMyMonthWork" method="post">
...
<%} %>
<input type="hidden" id="dayLimit" value="${dayLimit}"/>
...
<script type="text/javascript">
    ...
    function returnToday() {
        window.location.href = "queryMyMonthWork?logType=${logType}";
    }
