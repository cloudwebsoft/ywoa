...
<table class="tabStyle_1 percent98" cellSpacing="0" cellPadding="3" width="95%" align="center">
    <tr>
        <td width="18%" class="tabStyle_1_title">名称</td>
        <td width="20%" class="tabStyle_1_title">标题栏</td>
        <td width="5%" class="tabStyle_1_title" align="center">默认</td>
        <td width="7%" class="tabStyle_1_title" align="center">字体</td>
        <td width="7%" class="tabStyle_1_title" align="center">字号</td>
        <td width="8%" class="tabStyle_1_title" align="center">背景色</td>
        <td width="10%" class="tabStyle_1_title" align="center">前景色</td>
        <td width="5%" class="tabStyle_1_title" align="center">加粗</td>
        <td width="5%" class="tabStyle_1_title" align="center">行高</td>
...
<script language="javascript">
    $('.default-item').click(function () {
        $.ajax({
            type: "post",
            url: "setDefaultExportTempalte.do",
            data: {
                id: $(this).val(),
                moduleCode: '${code}',
