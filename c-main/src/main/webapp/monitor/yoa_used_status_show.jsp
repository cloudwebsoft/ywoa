...
<div id="tabs1">
  <ul>
    <li id="menu1">
    <a href="yoa_used_status_list.jsp?formCode=used_status"><span>云OA运行状态</span></a>
    </li>
    </ul>
    </div>
    </div>
...
%>
<input class="btn" type="button" onclick="window.location.href='yoaacc_edit.jsp?parentId=<%=id%>&id=<%=id%>&formCode=<%=formCode%>'" value="编 辑" />
<%}%>
    </td>
  </tr>
</table>
<form name="formWord" target="_blank" action="yoaacc_show_word.jsp" method="post">
