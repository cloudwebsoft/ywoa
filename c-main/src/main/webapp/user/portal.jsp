...
<body>
<div id="toolbar" style="height:25px; clear:both; margin-bottom:30px"></div>
...
<div id="dlg" style="display:none">
	<form id="form1">
		...
		<div style="display: none;">固定&nbsp;&nbsp;&nbsp;&nbsp;<input id="isFixed" name="isFixed" checked="checked" value="1" type="checkbox"/>&nbsp;不允许用户自定义<br/></div>
...
toolbar = new Toolbar({
  ...
  ,'-',{
	  ...
	  useable : 'T',
	  handler : function(){
		  var groupId = $("#sortable").children().eq(curIndex).attr("groupId");
		  var groupName = $("#sortable").children().eq(curIndex).attr("groupName");
		  addTab(groupName, "user/desktop_setup.jsp?portalId=" + groupId);
	  }
  }
  <%if (privilege.isUserPrivValid(request, "admin")) {%>
   ,'-',{
