...
<table cellpadding="6" cellspacing="0" border="0" width="100%">
    <tr>
        ...
        <td width="99%" align="center" valign="top">
            <div align="left"><b>欢迎您使用<%=com.redmoon.oa.Config.getInstance().get("enterprise")%><%=cfg.get("oa.version")%>&nbsp;<font style="font-size='14px';color='red'">ORACLE版本</font></b></div>
            <hr size="0">
            <%
                ...
                try {
                    ...
                    out.print("<font style='font-size:14px' color='#FF0000'>请检查proxool中的driver-class是否设置正确！<br>参照设置为：oracle.jdbc.driver.OracleDriver</font><br>");
                } catch (Exception e) {
                    out.print("<font style='font-size:14px' color='#FF0000'>请检查proxool中的driver-url是否设置正确！<br>参照设置为：jdbc:oracle:thin:@//192.168.1.27:1521/cwbbs</font><br>");
                }
            ...
            <div align="center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="button2" type="button" onclick="window.location.href='setup3.jsp?db_type=oracle'" value="下一步"/>
        </td>
    </tr>
</table>
