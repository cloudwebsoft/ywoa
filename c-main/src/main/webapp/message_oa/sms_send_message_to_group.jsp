...
function openWinUserGroup() {
	openWin("../user_usergroup_multi_sel.jsp", 800, 600);
}
...
function openWinTemplateSel(){
	openWin("sms_template_sel.jsp", 800, 600);
}
...
<thead>
  ...
  <tr> 
    ...
    <td width="329" height="27">
      ...
      <input class="btn" type=button onClick="openWinUserGroup()" value="选择用户组">
      <input class="btn" name="button" type=button onClick="openWinUserRole()" value="选择角色"></td>
  </tr>
  <tr>
