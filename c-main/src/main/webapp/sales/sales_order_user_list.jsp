...
<table cellSpacing="0" cellPadding="0" width="100%">
  <tbody>
    <tr>
      <td class="tdStyle_1">订单&nbsp;-&nbsp;<%=user.getRealName()%></td>
    </tr>
  </tbody>
</table>
<%
...
String sql = "select o.id from form_table_sales_order o where o.cws_creator=" + StrUtil.sqlstr(userName);
...
<tr> 
		<td align="right"><%
String querystr = "userName=" + StrUtil.UrlEncode(userName) + "&beginDate=" + strBeginDate + "&endDate=" + strEndDate;
out.print(paginator.getCurPageBlock("sales_order_user_list.jsp?" + querystr));
%></td>
  </tr>
</table>
</body>
