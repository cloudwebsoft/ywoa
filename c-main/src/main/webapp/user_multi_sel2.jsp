...
function noShared(){
	var r = confirm("取消分享后，他人将不能操作该文件夹。是否取消分享？");
	var dlg = window.opener ? window.opener : dialogArguments;
	if(r){
		dlg.noDirShared();
		window.close();
...
%>
<table width="80%" class="percent80" align="center">
<tr>
<td align="center">
<input id="selDeptAllBtn" class="btn" type="button" value="全选" onClick="selAllUserOfDept()">
&nbsp;
<input class="btn" type="button" name="okbtn" value="确定" onClick="setUsers()">
&nbsp;
<input class="btn" type="button" name="cancelbtn" value="关闭" onClick="window.close()">
</td>
</tr>
<tr>
<td align="center">
<input class="btn" type="button" name="okbtn" value="取消文件夹分享" onClick="noShared()">
&nbsp;
<input class="btn" type="button" name="cancelbtn" value="关闭" onClick="window.close()">
</td>
</tr>
...
<thead>
  <tr> 
    <td height="24" colspan="4" align="center"><span>选 择 用 户</span></td>
  </tr>
</thead>
  <tr> 
    <td height="87" colspan="2" valign="top" id="deptTree">
    <table width="100%" class="tabStyle_1_sub"><tr><td width="100%">
<%
DeptMgr dm = new DeptMgr();
DeptDb dd = dm.getDeptDb(unitCode);
DeptView tv = new DeptView(dd);
tv.ListFuncAjax(request, out, "", "updateResults", "", "", true);
%>
	</td></tr></table>
	</td>
    <td width="50%" align="center" valign="top">
   	<div id="searchIt" style="text-align:left;">&nbsp;姓名&nbsp;
   	<input type="text" id="search" name="search" onkeypress="searchByName()">
    <input class="btn" type="button" onclick="searchByName()" value="查找" />
    </div>
	<div id="resultTable">
<table width="100%" style="padding:0px" border="0" cellpadding="0" cellspacing="0" class="tabStyle_1_subTab">
        <thead>
        <tr>
          <th width="98" align="center" class="tabStyle_1_subTab_title">部门</th>
          <th width="91" align="center" class="tabStyle_1_subTab_title">职员</th>
          <th width="74" align="center" class="tabStyle_1_subTab_title">操作</th>
        </tr>
        </thead>
      <tbody id="postsbody">
