...
<%
	...
	/*8String what = ParamUtil.get(request, "what");
	...
	String sql = "select distinct a.id,a.sender,a.subject,a.mydate,a.is_readed,a.email_addr,a.msg_level from email a left join email_attach b on a.id = b.emailId where  a.email_addr=" + StrUtil.sqlstr(email) + " and a.msg_type=" + MailMsgDb.TYPE_INBOX;
			...
			String strToghter = "";
	  		while(ri.hasNext()){
	  			...
	  			String str ="<tr id=\""+rr.getInt("id")+"\" lang=\""+rr.getInt("is_readed")+"\">"
	  						...
	  						str += "<td><div style=\"width:220px;text-align:left;\"><a href=\"mail_show.jsp?id="+rr.getInt("id")+"&emailAddr="+rr.getString("email_addr")+"&subMenu="+subMneu+"&subMenuButton="+subMenuButton+"&box="+MailMsgDb.TYPE_INBOX+"\">"+sender+"</a></div></td><td><div style=\"width:500px;text-align:left;\"><a href=\"mail_show.jsp?id="+rr.getInt("id")+"&emailAddr="+rr.getString("email_addr")+"&subMenu="+subMneu+"&subMenuButton="+subMenuButton+"&box="+MailMsgDb.TYPE_INBOX+"\">"+subject+"</a></div></td><td><div style=\"width:180px;text-align:left;\">"+sd.format(sendTime)+"</div></td></tr>";	  
				
				/**
				String str ="<tr id=\""+rr.getInt("id")+"\" lang=\""+rr.getInt("is_readed")+"\">"
					+"<td>"+sender+"</td>"
					+"<td><a href=\"mail_show.jsp?id="+rr.getInt("id")+"&emailAddr="+rr.getString("email_addr")+"\">"+subject+"</a></td>"
					+"<td>"+sd.format(sendTime)+"<input type=\"hidden\" name=\"hiddenTotal\" id=\"hiddenTotal\" value=\""+total+"\"/></td></tr>";	 
					*/
	  			strToghter += str;
	  		}
