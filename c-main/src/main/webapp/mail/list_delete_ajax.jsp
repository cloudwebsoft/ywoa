...
<%
	...
	String sql = "select distinct a.id,a.sender,a.subject,a.mydate,a.is_readed,a.email_addr,a.msg_level from email a left join email_attach b on a.id = b.emailId where  a.email_addr=" + StrUtil.sqlstr(email) + " and a.msg_type=" + MailMsgDb.TYPE_DUSTBIN;
			...
			String strToghter = "";
	  		...
	  		while(ri.hasNext()){
	  			...
	  			String str ="<tr id=\""+rr.getInt("id")+"\" lang=\""+rr.getInt("is_readed")+"\">"
	  						...
	  						str+="<td><div style=\"width:190px;text-align:left;\"><a href=\"mail_show.jsp?id="+rr.getInt("id")+"&emailAddr="+rr.getString("email_addr")+"&subMenu="+subMenu+"&subMenuButton="+subMenuButton+"&box="+MailMsgDb.TYPE_DUSTBIN+"\">"+sender+"</a></div></td>";
	  						str+="<td><div style=\"width:500px;text-align:left;\"><a href=\"mail_show.jsp?id="+rr.getInt("id")+"&emailAddr="+rr.getString("email_addr")+"&subMenu="+subMenu+"&subMenuButton="+subMenuButton+"&box="+MailMsgDb.TYPE_DUSTBIN+"\">"+subject+"</a></div></td>";
