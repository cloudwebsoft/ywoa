...
var options = {"isWx":<%=isWx%>,"ulContainer":"#ul_nest_sheet_choose_select","ajax_params":params,"url":AJAX_REQUEST_URL.MODULE_LIST.NEST_SEL_LIST,"ajaxDatasType":LIST_TYPE.NEST_SHEET_CHOOSE_SELECT,"urlParams":'<%=urlParams%>'};
