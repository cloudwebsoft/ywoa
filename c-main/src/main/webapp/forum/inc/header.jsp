<%@ page contentType="text/html;charset=utf-8"%><%@ page import="cn.js.fan.util.*"%><%@ page import="cn.js.fan.web.*"%><%@ page import="java.util.*"%><%@ page import="com.redmoon.forum.ad.*"%><%@ page import="com.redmoon.forum.security.*"%><%@ page import="com.redmoon.forum.*"%><%@ page import="com.redmoon.forum.Leaf"%>
		...
		%>
			...
			if (headCt==navpos) {
				...
				while (irHeaderPlugin.hasNext()) {
					...
					if (ipu==null) {
						DebugUtil.i(getClass(), "PluginUnit", pu.getName(request) + " is not exist");
						continue;
					}
