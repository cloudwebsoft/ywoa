...
if (op.equals("modify")) {
	...
	if (sb.save())
		out.print(StrUtil.Alert(DigSkin.LoadString(request, "modifySucceed")));
	else
		out.print(StrUtil.Alert(DigSkin.LoadString(request, "modifyFail")));
}
%>
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<a href=manager.jsp><%=DigSkin.LoadString(request, "name")%></a>的规则</td>
  </tr>
</table>
<br>
