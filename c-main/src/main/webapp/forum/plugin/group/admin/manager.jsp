...
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  ...
  <tr> 
    <td valign="top"><table width="82%"  border="0" align="center">
      <tr>
        <td height="34" align="center"><img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;<a href="catalog_frame.jsp">朋友圈分类</a>&nbsp;&nbsp;<img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;&nbsp;<a href="config_m.jsp">朋友圈配置</a>&nbsp;&nbsp;&nbsp;<img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;<a href="group_list.jsp">朋友圈管理</a></td>
      </tr>
    </table>
      <br>
...
<%}%>	  
	  ...
	  <form action="?op=addBoard" method=post>
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="44%" align="left"><input type=submit value="设为支持<%=GroupSkin.LoadString(request, "name")%>功能"></td>
        </tr></form>
      </table>
      <br></td>
  </tr>
