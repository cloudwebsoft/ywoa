...
if (op.equals("addBoard")) {
	...
	PresentSkin sv = new PresentSkin();
	if (!boardCode.equals("")) {
...
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<%=PresentSkin.LoadString(request, "name")%></td>
  </tr>
</table>
<br>
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  <tr> 
    <td height=20 align="left" class="thead">管理 - <%=PresentSkin.LoadString(request, "name")%></td>
  </tr>
  <tr>
    <td valign="top"><br>
...
<%}%>
	  ...
	  <form action="?op=addBoard" method=post>
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="44%" align="left"><input type=submit value="设为支持<%=PresentSkin.LoadString(request, "name")%>功能"></td>
        </tr></form>
      </table>      <br>
      <br></td>
  </tr>
