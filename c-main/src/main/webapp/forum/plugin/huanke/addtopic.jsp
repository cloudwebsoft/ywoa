  ...
  <TBODY>
	<TR>
		...
		<%
			...
			out.print(sb);
		%>
	    </select><input type="hidden" name="pluginCode" value="<%=HuankeUnit.code%>"/></TD>
	</TR>	
	<TR>
        <TD width="20%" align="left" bgcolor="#F9FAF3">物品名称：</TD> 
        <TD width="80%" height=23 align="left" bgcolor="#F9FAF3"><input type="text" name="goods"/></TD>
    </TR>
	<TR>
	...
	<TR>
	  ...
	  <TD height=23 align="left" bgcolor="#F9FAF3">
	    <input type="text" name="exchangeProvince"/>	  </TD>
    </TR>
	<TR>
	...
	<TR>
	  ...
	  <TD height=23 align="left" bgcolor="#F9FAF3"><input type="text" name="price"/></TD>
    </TR>
	<TR>
	  <TD align="left" bgcolor="#F9FAF3">交换的物品地点：</TD>
	  <TD height=23 align="left" bgcolor="#F9FAF3"><input type="text" name="province"/></TD>
    </TR>
	<TR>
	...
	<TR id="exchangedetail" style="display:none">
	  <TD height="23" colspan="2" align="left" bgcolor="#F9FAF3"><table width="100%" border=0 align=center cellPadding=2 cellSpacing=1 bgcolor="#CCCCCC">
        <tr>
          ...
          <td width="80%" align="left" bgcolor="#F9FAF3"><select name="exchangeCatalogCode">
            <%
        ...
        <tr>
          ...
          <td align="left" bgcolor="#F9FAF3"><input type="text" name="exchangeGoods"/></td>
        </tr>
        <tr>
          <td align="left" bgcolor="#F9FAF3">交换条件说明：</td>
          <td align="left" bgcolor="#F9FAF3"><textarea name="exchangeDescription" rows="5" cols="25"></textarea></td>
        </tr>
      </table></TD>
    </TR>
  </TBODY>
