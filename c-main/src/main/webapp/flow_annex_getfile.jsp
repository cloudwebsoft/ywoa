...
<body style="text-align:center">
	<img title="点击查看原图" style="cursor:pointer" src="<%=request.getContextPath()%>/img_show.jsp?path=<%=waa.getVisualPath() + "/" + waa.getDiskName()%>" onclick="window.open('<%=waa.getVisualPath() + "/" + waa.getDiskName()%>')" />
</body>
</html>
	<%
	return;
