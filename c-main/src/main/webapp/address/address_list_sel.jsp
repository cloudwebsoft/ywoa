...
try {
	...
	%>
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom: 10px">
            <tr>
              <td width="23%" height="30" align="left">
				  <input class="btn" type="button" onclick="window.location.href='address_search.jsp?type=<%=type%>&flag=sel'" value="查询" />
              </td>
		...
		%>
              <tr align="center">
                ...
                <td align="left"><a href="javascript:;" onclick="openWin('show.do?id=<%=id%>&mode=show', 800, 600)"><%=person%></a></td>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" class="percent98">
              <tr>
                ...
                &nbsp;
                <input id="btnSelAll" type="button" class="btn" title="选择通讯录中全部人员" value="全部" onclick="ajaxSelAll('<%=type%>', '<%=groupType%>')" />
