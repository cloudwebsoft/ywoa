...
<table width="501" height="293" border="0" align="center" cellpadding="0" cellspacing="0" class="tabStyle_1">
    ...
    <tr>
        <td align="right"><select id="fieldsSelected" name="fieldsSelected" size=15 multiple style="width:200px;height:260px !important;" ondblclick="notsel();">
            <%=selOptions%>
        </select></td>
        ...
        <td>
            <select id="fieldsNotSelected" name="fieldsNotSelected" size=15 multiple style="width:200px;height:260px !important;" ondblclick="sel();">
                <%=options%>
            </select></td>
    </tr>
