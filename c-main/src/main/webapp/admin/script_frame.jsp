...
if (cfg.getBooleanProperty("isCloud")) {
	...
	cloudUrl += "/public/login_check.jsp?type=ide&sysVer=" + sysVer + "&sp=" + sp + "&ver=" + ver + "&com=" + StrUtil.UrlEncode(company) + "&entNum=" + StrUtil.UrlEncode(enterpriseNum) + "&cwsToken=" + cwsToken + "&extra=" + StrUtil.UrlEncode(Global.getFullRootPath() + "/admin/ide_left.jsp?formCode=" + StrUtil.UrlEncode(formCode));
