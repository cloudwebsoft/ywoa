    ...
    <td valign="top"><table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" class="stable">
      ...
      <form name="form1" action="boardroom_do.jsp?op=edit" method="post" onSubmit="">
        <tr>
          ...
          <td width="86%" height="19" class="stable"><input type="text" name="name" class="btn" size=50 value="<%=bd.getName()%>">
		  <input type="hidden" name="id" value="<%=id%>">
		  </td>
        </tr>
        <tr>
          <td height="24" align="center" class="stable">人&nbsp;&nbsp;数</td>
          <td height="20" class="stable"><input type="text" class="btn" name="personNum" size=15 value="<%=bd.getPersonNum()%>"></td>
        </tr>
        <tr>
          <td height="24" align="center" class="stable">位&nbsp;&nbsp;置</td>
          <td height="20" class="stable"><input type="text" class="btn" name="address" size=50 value="<%=bd.getAddress()%>"></td>
        </tr>
        <tr>
          <td height="24" align="center" class="stable">设&nbsp;&nbsp;备</td>
          <td height="20" class="stable">
              <input type="text" class="btn" name="equipment" size=50 value="<%=bd.getEquipment()%>">
          </td>
        </tr>
        <tr>
          <td height="17" align="center" class="stable">说&nbsp;&nbsp;明</td>
          <td height="17" class="stable"><textarea name="description" cols="60" class="btn" rows="10"><%=bd.getDescription()%></textarea>          </td>
        </tr>
        <tr>
