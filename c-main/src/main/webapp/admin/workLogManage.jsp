...
<form name="form1" method="post" action="workLogManage.jsp?op=search">
   <table class="searchTable" cellpadding="0"; cellspacing="0">
	  ...
	  <tr>
	    ...
	    <td width="24%">所属部门：<input type="text" name="deptNames" id="deptNames" value="<%=dept_names%>" onClick="openWinDepts('../dept_multi_sel.jsp?openType=open','800','600')">
	        		...
	        		while (ir.hasNext()) {
				 	...
				 	<tr align="center">
						...
						<td align="center" style="padding-top:10px;">
							<a title="查看" href="javascript:;" onclick="addTab('<%=DateUtil.format(myDate, "yyyy-MM-dd") %>', '<%=request.getContextPath()%>/mywork/showWorkLogById.do?workLogId=<%=logId%>&userName=<%=StrUtil.UrlEncode(myName)%>&isNav=1')">查看</a>
