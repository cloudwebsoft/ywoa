...
CWBBSConfig myconfig = CWBBSConfig.getInstance();
...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      <TD class="tdStyle_1">与CWBBS网站集成配置</TD>
    </TR>
  </TBODY>
</TABLE>
<br>
...
if (name!=null && !name.equals("")) {
	...
	out.println(fchar.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "config_cwbbs.jsp"));
	myconfig.reload();
	myconfig = CWBBSConfig.getInstance();	
	return;
}
%>
...
%>
  <form method="post" id="form<%=k%>" name="form<%=k%>" action='config_cwbbs.jsp'>
    <tr>
