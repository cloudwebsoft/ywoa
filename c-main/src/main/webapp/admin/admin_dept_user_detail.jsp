...
while (ir.hasNext()) {
	...
	<div class="workItem"><a title="工作报告" href="javascript:;" onclick="addTab('<%=ud.getRealName() %>的工作报告', '<%=request.getContextPath()/mywork/showWorkLogInfo.action?userName=<%=StrUtil.UrlEncode(ud.getName())%>')"><strong>工作报告</strong></a></div>
