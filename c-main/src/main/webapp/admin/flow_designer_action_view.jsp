...
// 解析表单中的元素，包括控件、表格行、span、div
    ...
    <script language="JavaScript">
        ...
        function onload() {
            ...
            var xml = $.parseXML('<%=wpd.getViews().replaceAll("\r\n", "")%>');
            $xml = $(xml);
            ...
            $xml.find("actions").children().each(function (i) {
                if ($(this).attr("internalName") == "<%=internalName%>") {
                    ...
                    $(this).children().each(function () {
                        ...
                        str += "  </td>";
                        str += "<td class='delBtn'>";
                        str += "<a href='javascript:;' onclick=\"$('#views" + count + "').remove();\">×</a>";
...
<table id="tabCond" align="center" cellpadding="2" cellspacing="0" class="tabStyle_1"
    ...
    <tr>
        <td height="22" colspan="5" align="center">
            ...
            &nbsp;&nbsp;
            <input type="button" value="增加" onclick="addCond()" class="btn btn-default"/></td>
    </tr>
</table>
