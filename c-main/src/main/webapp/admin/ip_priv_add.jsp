...
<table cellSpacing="0" cellPadding="0" width="100%">
  <tbody>
    <tr>
      <td class="tdStyle_1">设置目录 <a href="ip_priv_list.jsp?serverIPId=<%=serverIPId%>"><%=sid.getString("description")%></a> 权限</td>
    </tr>
  </tbody>
</table>
<br>
...
while (ir.hasNext()) {
    ...
    <tr class="highlight">
      ...
      <td><%=desc%></td>
      <td align="center">
	  <a href="ip_priv_list.jsp?op=add&serverIPId=<%=serverIPId%>&name=<%=StrUtil.UrlEncode(code)%>&type=<%=ServerIPPriv.TYPE_USERGROUP%>">[ 添加 ]</a></td>
    </tr>
<%}%>
  </tbody>
</table>
...
<table class="tabStyle_1 percent60" width="492"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	用户名：
	  ...
	  &nbsp;&nbsp;<input class="btn" onClick="javascript:showModalDialog('../user_sel.jsp',window.self,'dialogWidth:640px;dialogHeight:480px;status:no;help:no;')" value="选择用户" type="button" />
	  &nbsp;&nbsp;
