...
<table width="100%"  border="0" style="background-image:url(images/bg_left.jpg); background-repeat:no-repeat">
  <tr>
    <td height="73" align="left"><table width="100%"  border="0">
      <tr>
        <td height="33" align="left" style="FILTER: glow(color=ffffff)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="#0099FF">网络邻居</font></strong></td>
      </tr>
      <tr>
...
tv.ListSimple(request, out, "mainNeighborPostFrame", "netdisk_neighbor_post_list.jsp", "", "" );
%>
</td>
  </tr>
</table>
