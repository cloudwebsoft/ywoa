...
Iterator ir = fdao.getAttachments().iterator();
  ...
  <tr>
	...
	<input class="btn" type="button" value=" 编辑 " onclick="window.open('module_mode1_edit_relate.jsp?id=<%=id%>&formCodeRelated=<%=formCodeRelated%>&formCode=<%=formCode%>&isShowNav=0')" />
	<%}%>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
