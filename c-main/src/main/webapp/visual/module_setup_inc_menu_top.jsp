...
<div id="tabs1">
    <ul>
        ...
        <li id="menu10"><a
                href="<%=request.getContextPath()%>/visual/module_field_conds.jsp?code=<%=codeTop%>&formCode=<%=formCodeTop%>"><span>查询设置</span></a>
        </li>
        <li id="menu2"><a
                href="<%=request.getContextPath()%>/visual/module_priv_list.jsp?code=<%=codeTop%>&formCode=<%=formCodeTop%>"><span>权限设置</span></a>
        </li>
        <li id="menu4"><a
        ...
        %>
        <li id="menu7"><a
                href="<%=request.getContextPath()%>/visual/module_scripts_iframe.jsp?code=<%=codeTop%>&formCode=<%=formCodeTop%>"><span>事件脚本</span></a>
        </li>
        <%
            }
        %>
        ...
        <li id="menu5"><a href="javascript:"
                          onclick="addTab('<%=fedb.getName()%>-表单编辑', '<%=request.getContextPath()%>/admin/form_edit.jsp?code=<%=formCodeTop%>')"><span>表单编辑</span></a>
        </li>
        <%}%>
    </ul>
</div>
