...
<font color="#FF0000">*</font></tr>
    ...
    <tr>
	  ...
	  <input name="principal" type="hidden" id="principal" value="<%=principal%>">
        ...
        &nbsp;
        <input class="btn" onClick="o('principal').value='';o('principalRealNames').value=''" type="button" value="清空" name="button"></td>
    </tr>
    <tr>
      <td noWrap>参与人：</td>
      <td>
        ...
        &nbsp;
        <input class="btn" onClick="o('users').value='';o('userRealNames').value=''" type="button" value="清空" name="button"></td>
    </tr>    
    <tr>
      <td noWrap>备注：</td>
