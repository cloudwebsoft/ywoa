...
<div id="drag_<%=id%>" dragTitle="<%=udsd.getTitle()%>" count="<%=udsd.getCount()%>"
    ...
    <div id="drag_<%=id%>_h" class="box ibox-title">
        ...
        %>
        <h5>
            <i class="fa <%=udsd.getIcon()%>"></i>&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/mywork/queryMyWeekWork.action?logType=2"><%=udsd.getTitle()%></a>
        </h5>
        <%
        }
        else {
        ...
        <div class="titleimg">
            ...
            &nbsp;&nbsp;</div>
        <div class="titletxt">&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/mywork/queryMyWeekWork.action?logType=2"><%=udsd.getTitle()%></a></div>
        <%
            }
        %>
    </div>
        ...
        <table class='article_table'>
            ...
            <tr>
                ...
                <td class='article_time' style="width:135px">[<%=wld.getLogItem()%>
                    月&nbsp;<%=DateUtil.format(wld.getMyDate(), "yyyy-MM-dd")%>]
                </td>
            </tr>
            <%}%>
        </table>
