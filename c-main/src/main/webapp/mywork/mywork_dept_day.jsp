...
%>
    <tr>
	  ...
	  <a href="javascript:;" onclick="addTab('<%=user.getRealName()%> 工作报告', '<%=request.getContextPath()%>/mywork/showWorkLogInfo.action?userName=<%=StrUtil.UrlEncode(user.getName())%>')"><%=user.getRealName()%></a>
      </td>
      <%
