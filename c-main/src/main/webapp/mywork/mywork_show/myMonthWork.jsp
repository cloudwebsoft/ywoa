...
<html>
<head>
    <title><s:property value="pageTitle"/>的工作月报</title>
...
<!--日报时间选择-->
    <div class="mywork-list-time">
      ...
      <form id="initForm" name="initForm" action="<%=request.getContextPath()%>/mywork/queryMyMonthWorkForShow" method="post"  enctype="multipart/form-data">
