...
String s = Global.getRealPath() + "upfile/address/" + userName + ".txt";
...
response.setHeader("Content-Disposition", "attachment;filename=\"" + StrUtil.GBToUnicode("address.txt") + "\"");
