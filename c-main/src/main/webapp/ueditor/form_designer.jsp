...
<div class="span2">
  ...
  <div class="formdesigner-menutitle">表单设计器</div>
  <div class="formdesigner-menubox">
<ul>
    <li><a onclick="cwsFormDesigner.exec('text');" href="javascript:void(0);"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_1.png" width="18" height="18" />&nbsp;&nbsp;文本框</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('textarea');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_2.png" width="18" height="18" />&nbsp;&nbsp;多行文本</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('select');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_3.png" width="18" height="18" />&nbsp;&nbsp;下拉菜单</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('radios');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_4.png" width="18" height="18" />&nbsp;&nbsp;单选框</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('checkbox');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_5.png" width="18" height="18" />&nbsp;&nbsp;复选框</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('macros');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_6.png" width="18" height="18" />&nbsp;&nbsp;宏控件</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('calendar');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_7.png" width="18" height="18" />&nbsp;&nbsp;日历控件</a></li>
     <!--<li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('progressbar');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_8.png" width="18" height="18" />&nbsp;&nbsp;进度条</a></li> -->
     <!--<li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('qrcode');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_9.png" width="18" height="18" />&nbsp;&nbsp;二维码</a></li>-->
    <!-- <li><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_1.png" width="18" height="18" />&nbsp;&nbsp;<a href="javascript:void(0);" onclick="cwsFormDesigner.exec('listctrl');" class="btn btn-link">列表控件</a></li> -->
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('button');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_10.png" width="18" height="18" />&nbsp;&nbsp;按钮</a></li>
    <li><a href="javascript:void(0);" onclick="cwsFormDesigner.exec('calculation');"><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_11.png" width="18" height="18" />&nbsp;&nbsp;计算控件</a></li>
    <!-- <li><img src="<%=SkinMgr.getSkinPath(request)%>/images/form_designer/formdesigner_1.png" width="18" height="18" />&nbsp;&nbsp;<a href="javascript:void(0);" onclick="cwsFormDesigner.exec('more');" class="btn btn-link">一起参与...</a></li> -->
    ...
    <!-- <input id="btnOk" type="button" value="确定" onClick="save()" />
    </li>
    <li>
    <input id="btnOk" type="button" value="取消" onClick="window.close()" />
    </li> -->
