...
public class DebateViewEditMsg implements IPluginViewEditMsg {
    HttpServletRequest request;
    public final String FORM_EDIT = "FORM_ADD";

    public DebateViewEditMsg(HttpServletRequest request, String boardCode, long msgId) {
    ...
    public void init() {
        formElement = "";
        formNote = DebateSkin.LoadString(request, "LABEL_EDIT_MSG");
        // 脚本
        // formNote += "<script src='plugin/" + DebateSkin.code + "/script.js'></script>\n";
