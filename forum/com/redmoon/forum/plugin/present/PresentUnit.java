...
public class PresentUnit implements IPluginUnit {
    public static final String code = "present";

    public PresentUnit() {
    }

    public IPluginUI getUI(HttpServletRequest request, HttpServletResponse response, JspWriter out) {
        return new PresentUI(request);
    }

    public IPluginPrivilege getPrivilege() {
        return new PresentPrivilege();
    }
