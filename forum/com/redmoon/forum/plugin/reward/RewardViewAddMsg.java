...
public class RewardViewAddMsg implements IPluginViewAddMsg {
    public final String FORM_ADD = "FORM_ADD";

    String boardCode;
    HttpServletRequest request;

    public RewardViewAddMsg(HttpServletRequest request, String boardCode) {
    ...
    public void init() {
        formElement = RewardSkin.LoadString(request, FORM_ADD);
    }
    ...
    public String render(int position) {
        ...
        case UIAddMsg.POS_TITLE:
            str += RewardSkin.LoadString(request, "addMsgTitle");
            break;
