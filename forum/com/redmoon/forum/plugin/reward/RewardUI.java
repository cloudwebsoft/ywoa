...
public class RewardUI implements IPluginUI {
    HttpServletRequest request;

    public RewardUI(HttpServletRequest request) {
    ...
    public IPluginViewListThread getViewListThread(String boardCode) {
        return new RewardViewListThread(request, boardCode);
    }

    public IPluginViewAddMsg getViewAddMsg(String boardCode) {
        return new RewardViewAddMsg(request, boardCode);
    }

    public IPluginViewAddReply getViewAddReply(String boardCode, long msgRootId) {
        return new RewardViewAddReply(request, boardCode, msgRootId);
    }

    public IPluginViewEditMsg getViewEditMsg(String boardCode, long msgId) {
        return new RewardViewEditMsg(request, boardCode, msgId);
    }
    ...
    public IPluginViewShowMsg getViewShowMsg(String boardCode, MsgDb msgDb) {
        return new RewardViewShowMsg(request, boardCode, msgDb);
    }

    public ISkin getSkin() {
        return new RewardSkin();
    }
}
