...
public class SubjectView {
    ...
    Logger logger = Logger.getLogger(SubjectView.class.getName());
    SubjectDb rootLeaf;
    Vector UprightLineNodes = new Vector(); //用于显示竖线

    public SubjectView(SubjectDb rootLeaf) {
    ...
    // 显示根结点为leaf的树
    void ListTree(JspWriter out, SubjectDb leaf,
     ...
     **/
    void ShowLeaf(JspWriter out, SubjectDb leaf,
                  boolean isLastChild) throws Exception {
        ...
        if (!isLastChild) {
            SubjectDb brotherleaf = leaf.getBrother("down");
...
*/
    ...
    void ShowDirAsOption(JspWriter out, SubjectDb leaf, int rootlayer)
                  throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirAsOption(SubjectDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    public String getDirNameAsOptionValue(SubjectDb leaf, int rootlayer) {
        String outStr = "";
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
    ...
    // 显示根结点为leaf的树
    public void ShowDirAsOptions(JspWriter out, SubjectDb leaf, int rootlayer) throws Exception {
    ...
    public StringBuffer getDirAsOptions(StringBuffer outStr, SubjectDb leaf, int rootlayer) throws ErrMsgException {
    ...
    public StringBuffer getDirNameAsOptions(StringBuffer outStr, SubjectDb leaf, int rootlayer) throws ErrMsgException {
    ...
    // 显示根结点为leaf的树
    void ListTreeSimple(JspWriter out, SubjectDb leaf,
     ...
     * isLastChild 是否为其父亲结点的最后一个孩子结点
     **/
    void ShowLeafSimple(JspWriter out, SubjectDb leaf,
                  boolean isLastChild, String target, String link, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFunc(JspWriter out, SubjectDb leaf,
    ...
    void ShowLeafFunc(JspWriter out, SubjectDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
     ...
     * @throws Exception
     */
    void ListTreeFuncWithCheckbox(JspWriter out, SubjectDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
    ...
    void ShowLeafFuncWithCheckbox(JspWriter out, SubjectDb leaf,
                  boolean isLastChild, String target, String func, String tableClass, String tableClassMouseOn) throws Exception {
        String code = leaf.getCode();
        String name = leaf.getName();
        int layer = leaf.getLayer();
        ...
        // checkbox
        if (!code.equals(SubjectDb.ROOTCODE))
