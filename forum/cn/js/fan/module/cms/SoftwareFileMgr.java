...
public class SoftwareFileMgr {
    ...
    public FileUpload doUpload(ServletContext application,
        ...
        String ext_software = cfg.getProperty("cms.ext_software");
        String[] ext = StrUtil.split(ext_software, ",");
    ...
    public boolean create(ServletContext application,
        ...
        if (fileUpload.getRet() == FileUpload.RET_SUCCESS) {
            ...
            String visualPath = cfg.getProperty("cms.file_software") + "/" + year + "/" + month;
    ...
    public boolean del(HttpServletRequest request, long id) throws
            ErrMsgException {
        SoftwareFileDb doc = new SoftwareFileDb();
        doc = getSoftwareFileDb(id);
